...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},_y={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new ue(0)},defaultOpacity:{value:0}},vertexShader:`
...
`;class Gy{mesh;material;params={colorCenter:"#0a4d70",colorEdge:"#000000",radius:.58,intensity:.3};tmpColor=new ue;constructor(){const e=new Cr(2,2);this.material=new Rt({vertexShader:zy,fragmentShader:Hy,uniforms:{uColorCenter:{value:new ue(this.params.colorCenter)},uColorEdge:{value:new ue(this.params.colorEdge)},uRadius:{value:this.params.radius},uIntensity:{value:this.params.intensity}},depthWrite:!1,depthTest:!1}),this.mesh=new bt(e,this.material),this.mesh.renderOrder=-1,this.mesh.frustumCulled=!1}attachToCamera(e){this.mesh.position.z=-1,e.add(this.mesh)}sync(){const e=this.material.uniforms;this.tmpColor.set(this.params.colorCenter),e.uColorCenter.value.copy(this.tmpColor),this.tmpColor.set(this.params.colorEdge),e.uColorEdge.value.copy(this.tmpColor),e.uRadius.value=this.params.radius,e.uIntensity.value=this.params.intensity}}const Va={transparent:!0,blending:td,blendEquation:Kn,blendSrc:Co,blendDst:Za,blendEquationAlpha:Kn,blendSrcAlpha:nd,blendDstAlpha:Za,depthWrite:!1},Ru=["#ff2d6f","#ff5500","#ffd23f","#a020f0","#3b82d4","#06d6a0"];function Wy(i=128){const e=document.createElement("canvas");e.width=i,e.height=i;const t=e.getContext("2d"),n=i/2,s=i/2,r=t.createRadialGradient(n,n,0,n,n,s);r.addColorStop(0,"rgba(255,255,255,0.95)"),r.addColorStop(.08,"rgba(255,255,255,0.55)"),r.addColorStop(.22,"rgba(255,255,255,0.18)"),r.addColorStop(.5,"rgba(255,255,255,0.04)"),r.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=r,t.fillRect(0,0,i,i);const o=new fc(e);return o.needsUpdate=!0,o}const za=[{t:0,a:0},{t:.2,a:.08},{t:.38,a:.3},{t:.5,a:.7},{t:.62,a:.3},{t:.8,a:.08},{t:1,a:0}];function Xy(i){for(let e=0;e<za.length-1;e++){const t=za[e],n=za[e+1];if(i>=t.t&&i<=n.t){const s=n.t-t.t||1,r=(i-t.t)/s;return t.a+(n.a-t.a)*r}}return 0}function jy(i=256){const e=document.createElement("canvas");e.width=4,e.height=i;const t=e.getContext("2d"),n=t.createImageData(4,i);for(let r=0;r<i;r++){const o=r/(i-1),a=Math.round(Xy(o)*255);for(let l=0;l<4;l++){const c=(r*4+l)*4;n.data[c+0]=255,n.data[c+1]=255,n.data[c+2]=255,n.data[c+3]=a}}t.putImageData(n,0,0);const s=new fc(e);return s.needsUpdate=!0,s}function Ky(i=256){const e=document.createElement("canvas");e.width=4,e.height=i;const t=e.getContext("2d"),n=t.createLinearGradient(0,0,0,i);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.25,"rgba(255,255,255,0.08)"),n.addColorStop(.5,"rgba(255,255,255,0.4)"),n.addColorStop(.75,"rgba(255,255,255,0.08)"),n.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=n,t.fillRect(0,0,4,i);const s=new fc(e);return s.needsUpdate=!0,s}class qy{scene;group;beamMeshes=[];glowMeshes=[];rayDirs=[];rayMids=[];vanishingPoint=tf;tmpPulsePos=new R;tmpToCam=new R;tmpWidth=new R;tmpNormal=new R;tmpMat=new Ne;rayStarts=[];rayEnds=[];pulses=[];pulseTexture;pulseMaterial;beamTexture;beamMaterial;glowTexture;glowMaterial;fanEuler=new Sn(0,0,0,"YXZ");fanQuat=new Yt;rayOffset=new R;tmpRayEnd=new R;params={directionYaw:-.95,directionPitch:0,rayCount:18,spreadMin:9.5,spreadMax:13.5,convergenceLength:100,lineOpacity:.07,hdrBoost:1.05};beamParams={widthStart:.15,widthEnd:4.2,brightnessFar:.5,glowEnabled:!0,glowWidthMult:.8,glowOpacity:.3};pulseParams={pulsesPerRay:3,radius:.09,haloScale:2.8,speedMin:.18,speedMax:.42,speedMult:1.15,minKickInterval:.22,kickPopScale:1.6,kickPopDecay:14,kickThreshold:.22,rearmThreshold:.07,halosPerRaySustained:3,halosPerRayNormal:1,sustainedVifEnergyT:.7,sustainedVifHoldMs:400,audioGate:.04,sizeFar:.45,sizeNear:1.4};kickDetector=new Sc({riseThreshold:.22,fallThreshold:.07});lastKickLaunchMs=0;sustainedVifState={prevSmooth:-1,holdMs:0};sustainedVifActive=!1;constructor(e){this.scene=e,this.group=new mi,this.scene.add(this.group),this.rebuild()}resize(e,t){}syncLineOpacity(){this.beamMaterial&&(this.beamMaterial.opacity=this.params.lineOpacity),this.glowMaterial&&(this.glowMaterial.opacity=this.beamParams.glowOpacity)}rebuild(){this.disposeGroup(),this.buildBeams(),this.buildPulses()}disposeGroup(){const e=new Set;for(;this.group.children.length>0;){const t=this.group.children[0];this.group.remove(t),t instanceof bt&&!e.has(t.geometry)&&(t.geometry.dispose(),e.add(t.geometry))}this.pulseTexture?.dispose(),this.pulseMaterial?.dispose(),this.beamTexture?.dispose(),this.beamMaterial?.dispose(),this.glowTexture?.dispose(),this.glowMaterial?.dispose(),this.pulseTexture=void 0,this.pulseMaterial=void 0,this.beamTexture=void 0,this.beamMaterial=void 0,this.glowTexture=void 0,this.glowMaterial=void 0,this.beamMeshes=[],this.glowMeshes=[],this.rayDirs=[],this.rayMids=[],this.pulses=[],this.rayStarts=[],this.rayEnds=[]}getRayEnd(e,t,n,s){const{convergenceLength:r}=this.params;this.rayOffset.set(Math.cos(t)*n,Math.sin(t)*n*.7,r);const{directionYaw:o,directionPitch:a}=this.params;return this.fanEuler.set(a,o,0),this.fanQuat.setFromEuler(this.fanEuler),this.rayOffset.applyQuaternion(this.fanQuat),(s??new R).copy(e).add(this.rayOffset)}buildBeams(){const{rayCount:e,spreadMin:t,spreadMax:n,hdrBoost:s}=this.params,{widthStart:r,widthEnd:o,brightnessFar:a,glowEnabled:l,glowWidthMult:c}=this.beamParams,u=this.vanishingPoint;this.rayStarts=[],this.rayEnds=[],this.rayDirs=[],this.rayMids=[],this.beamMeshes=[],this.glowMeshes=[],this.beamTexture=jy(),this.beamMaterial=new Rn({map:this.beamTexture,vertexColors:!0,opacity:this.params.lineOpacity,...Va,depthWrite:!1,depthTest:!0,side:fn,toneMapped:!1}),this.glowTexture=Ky(),this.glowMaterial=new Rn({map:this.glowTexture,vertexColors:!0,opacity:this.beamParams.glowOpacity,...Va,depthWrite:!1,depthTest:!0,side:fn,toneMapped:!1});for(let h=0;h<e;h++){const d=h/e*Math.PI*2,p=t+Math.random()*(n-t),g=this.getRayEnd(u,d,p,this.tmpRayEnd).clone(),_=g.clone().sub(u),m=_.length();_.normalize();const f=u.clone().add(g).multiplyScalar(.5);this.rayStarts.push(u.clone()),this.rayEnds.push(g.clone()),this.rayDirs.push(_),this.rayMids.push(f);const w=m/2,S=new Float32Array([-w,r,0,-w,-r,0,w,-o,0,w,o,0]),b=new Float32Array([0,0,0,1,1,1,1,0]),T=new ue(Ru[h%Ru.length]),A=s,P=s*a,D=new Float32Array([T.r*A,T.g*A,T.b*A,T.r*A,T.g*A,T.b*A,T.r*P,T.g*P,T.b*P,T.r*P,T.g*P,T.b*P]),M=new Jt;M.setAttribute("position",new _t(S,3)),M.setAttribute("uv",new _t(b,2)),M.setAttribute("color",new _t(D,3)),M.setIndex([0,1,2,0,2,3]);const y=new bt(M,this.beamMaterial);if(y.layers.enable(dr),y.frustumCulled=!1,y.renderOrder=1,y.position.copy(f),this.beamMeshes.push(y),this.group.add(y),l){const I=new bt(M,this.glowMaterial);I.scale.y=c,I.position.copy(f),I.layers.enable(dr),I.frustumCulled=!1,I.renderOrder=0,this.glowMeshes.push(I),this.group.add(I)}}this.syncLineOpacity()}orientBeams(e){for(let t=0;t<this.beamMeshes.length;t++){const n=this.beamMeshes[t],s=this.rayDirs[t],r=this.rayMids[t];this.tmpToCam.copy(e.position).sub(r).normalize();const o=this.tmpToCam.dot(s);if(this.tmpNormal.copy(this.tmpToCam).addScaledVector(s,-o),this.tmpNormal.lengthSq()<1e-5)continue;this.tmpNormal.normalize(),this.tmpWidth.copy(this.tmpNormal).cross(s).normalize(),this.tmpMat.makeBasis(s,this.tmpWidth,this.tmpNormal),n.quaternion.setFromRotationMatrix(this.tmpMat);const a=this.glowMeshes[t];a&&a.quaternion.setFromRotationMatrix(this.tmpMat)}}buildPulses(){const{pulsesPerRay:e,speedMin:t,speedMax:n}=this.pulseParams,s=this.rayStarts.length;this.pulseTexture=Wy(),this.pulseMaterial=new Id({map:this.pulseTexture,...Va,depthTest:!0});for(let r=0;r<s;r++)for(let o=0;o<e;o++){const a=new Im(this.pulseMaterial);a.layers.enable(dr),a.center.set(.5,.5),this.group.add(a),a.visible=!1,this.pulses.push({sprite:a,rayIndex:r,t:0,speed:t+Math.random()*(n-t),active:!1,launchPop:0})}}update(e=0,t=0,n){const s=e/1e3,{kick:r}=Fi(),o=pt.lerp(ps.neonSpeedFloor,1,yr(t)),{kickThreshold:a,rearmThreshold:l,audioGate:c}=this.pulseParams,u=t>=c,{sustainedVifEnergyT:h,sustainedVifHoldMs:d}=this.pulseParams,p=cy(t,this.sustainedVifState,s,{energyTMin:h,holdMs:d});if(this.logSustainedVifModeChange(p,t,{energyT:yr(t),holdMs:this.sustainedVifState.holdMs}),!u)this.logSustainedVifModeChange(!1,t,{reason:"audioGate"}),this.hideAllPulses(),this.kickDetector.reset();else{if(this.kickDetector.setThresholds(a,l),this.kickDetector.update(r)){const g=performance.now(),{minKickInterval:_}=this.pulseParams,m=g-this.lastKickLaunchMs>=_*1e3,f=this.countIdlePulseSlots();if(m&&f>0){const w=p?this.pulseParams.halosPerRaySustained:this.pulseParams.halosPerRayNormal;this.launchPulseOnKick(w),this.lastKickLaunchMs=g}}this.updatePulseSprites(s,o)}n&&this.orientBeams(n)}logSustainedVifModeChange(e,t,n={}){}countIdlePulseSlots(){let e=0;for(const t of this.pulses)t.active||e++;return e}stop(){this.hideAllPulses(),this.kickDetector.reset()}hideAllPulses(){for(const e of this.pulses)e.active=!1,e.sprite.visible=!1,e.launchPop=0}launchPulseOnKick(e){const t=this.rayStarts.length;let n=0;for(let s=0;s<t;s++){let r=0;for(const o of this.pulses)if(!(o.rayIndex!==s||o.active)&&(o.t=0,o.active=!0,o.launchPop=1,o.sprite.visible=!0,n++,r++,r>=e))break}return n}updatePulseSprites(e,t=1){const{radius:n,haloScale:s,speedMult:r,kickPopScale:o,sizeFar:a,sizeNear:l}=this.pulseParams,{kickPopDecay:c}=this.pulseParams,u=r*t;for(const h of this.pulses){if(!h.active){h.sprite.visible=!1;continue}const d=this.rayStarts[h.rayIndex],p=this.rayEnds[h.rayIndex];if(!d||!p)continue;if(h.t+=h.speed*u*e,h.launchPop>0&&(h.launchPop=Math.max(0,h.launchPop-e*c)),h.t>=1){h.active=!1,h.sprite.visible=!1,h.t=0,h.launchPop=0;continue}h.sprite.visible=!0,this.tmpPulsePos.lerpVectors(d,p,h.t),h.sprite.position.copy(this.tmpPulsePos);const g=a+(l-a)*h.t,_=1+h.launchPop*o,m=n*s*g*_;h.sprite.scale.set(m,m,1)}}}class Yy{experience;scene;resources;environment;silhouette;blobManager;background;neonRays;constructor(){this.experience=zs(),this.scene=this.experience.scene,this.resources=this.experience.resources,this.background=new Gy,this.background.attachToCamera(this.experience.camera.instance),this.environment=new Vy,this.silhouette=new Iy,this.blobManager=new By(this.scene,this.silhouette),this.neonRays=new qy(this.scene)}update(){const{volumeSmooth:e}=Fi();this.silhouette?.update(),this.neonRays.update(this.experience.time.delta,e,this.experience.camera.instance),this.blobManager.update(this.experience.time.delta)}}function mt(i){return i==null}function Ec(i){return i!==null&&typeof i=="object"}function Wl(i){return i!==null&&typeof i=="object"}function $y(i,e){if(i.length!==e.length)return!1;for(let t=0;t<i.length;t++)if(i[t]!==e[t])return!1;return!0}function Oi(i,e){return Array.from(new Set([...Object.keys(i),...Object.keys(e)])).reduce((n,s)=>{const r=i[s],o=e[s];return Wl(r)&&Wl(o)?Object.assign(Object.assign({},n),{[s]:Oi(r,o)}):Object.assign(Object.assign({},n),{[s]:s in e?o:r})},{})}function Zy(i){return Ec(i)?"target"in i:!1}const Jy={alreadydisposed:()=>"View has been already disposed",invalidparams:i=>`Invalid parameters for '${i.name}'`,nomatchingcontroller:i=>`No matching controller for '${i.key}'`,nomatchingview:i=>`No matching view for '${JSON.stringify(i.params)}'`,notbindable:()=>"Value is not bindable",notcompatible:i=>`Not compatible with  plugin '${i.id}'`,propertynotfound:i=>`Property '${i.name}' not found`,shouldneverhappen:()=>"This error should never happen"};class rn{static alreadyDisposed(){return new rn({type:"alreadydisposed"})}static notBindable(){return new rn({type:"notbindable"})}static notCompatible(e,t){return new rn({type:"notcompatible",context:{id:`${e}.${t}`}})}static propertyNotFound(e){return new rn({type:"propertynotfound",context:{name:e}})}static shouldNeverHappen(){return new rn({type:"shouldneverhappen"})}constructor(e){var t;this.message=(t=Jy[e.type](e.context))!==null&&t!==void 0?t:"Unexpected error",this.name=this.constructor.name,this.stack=new Error(this.message).stack,this.type=e.type}toString(){return this.message}}class Fo{constructor(e,t){this.obj_=e,this.key=t}static isBindable(e){return!(e===null||typeof e!="object"&&typeof e!="function")}read(){return this.obj_[this.key]}write(e){this.obj_[this.key]=e}writeProperty(e,t){const n=this.read();if(!Fo.isBindable(n))throw rn.notBindable();if(!(e in n))throw rn.propertyNotFound(e);n[e]=t}}class an{constructor(){this.observers_={}}on(e,t,n){var s;let r=this.observers_[e];return r||(r=this.observers_[e]=[]),r.push({handler:t,key:(s=n?.key)!==null&&s!==void 0?s:t}),this}off(e,t){const n=this.observers_[e];return n&&(this.observers_[e]=n.filter(s=>s.key!==t)),this}emit(e,t){const n=this.observers_[e];n&&n.forEach(s=>{s.handler(t)})}}class Qy{constructor(e,t){var n;this.constraint_=t?.constraint,this.equals_=(n=t?.equals)!==null&&n!==void 0?n:((s,r)=>s===r),this.emitter=new an,this.rawValue_=e}get constraint(){return this.constraint_}get rawValue(){return this.rawValue_}set rawValue(e){this.setRawValue(e,{forceEmit:!1,last:!0})}setRawValue(e,t){const n=t??{forceEmit:!1,last:!0},s=this.constraint_?this.constraint_.constrain(e):e,r=this.rawValue_;this.equals_(r,s)&&!n.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.rawValue_=s,this.emitter.emit("change",{options:n,previousRawValue:r,rawValue:s,sender:this}))}}class eM{constructor(e){this.emitter=new an,this.value_=e}get rawValue(){return this.value_}set rawValue(e){this.setRawValue(e,{forceEmit:!1,last:!0})}setRawValue(e,t){const n=t??{forceEmit:!1,last:!0},s=this.value_;s===e&&!n.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.value_=e,this.emitter.emit("change",{options:n,previousRawValue:s,rawValue:this.value_,sender:this}))}}class tM{constructor(e){this.emitter=new an,this.onValueBeforeChange_=this.onValueBeforeChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.value_=e,this.value_.emitter.on("beforechange",this.onValueBeforeChange_),this.value_.emitter.on("change",this.onValueChange_)}get rawValue(){return this.value_.rawValue}onValueBeforeChange_(e){this.emitter.emit("beforechange",Object.assign(Object.assign({},e),{sender:this}))}onValueChange_(e){this.emitter.emit("change",Object.assign(Object.assign({},e),{sender:this}))}}function Pt(i,e){const t=e?.constraint,n=e?.equals;return!t&&!n?new eM(i):new Qy(i,e)}function nM(i){return[new tM(i),(e,t)=>{i.setRawValue(e,t)}]}class qe{constructor(e){this.emitter=new an,this.valMap_=e;for(const t in this.valMap_)this.valMap_[t].emitter.on("change",()=>{this.emitter.emit("change",{key:t,sender:this})})}static createCore(e){return Object.keys(e).reduce((n,s)=>Object.assign(n,{[s]:Pt(e[s])}),{})}static fromObject(e){const t=this.createCore(e);return new qe(t)}get(e){return this.valMap_[e].rawValue}set(e,t){this.valMap_[e].rawValue=t}value(e){return this.valMap_[e]}}class Wo{constructor(e){this.values=qe.fromObject({max:e.max,min:e.min})}constrain(e){const t=this.values.get("max"),n=this.values.get("min");return Math.min(Math.max(e,n),t)}}class iM{constructor(e){this.values=qe.fromObject({max:e.max,min:e.min})}constrain(e){const t=this.values.get("max"),n=this.values.get("min");let s=e;return mt(n)||(s=Math.max(s,n)),mt(t)||(s=Math.min(s,t)),s}}class sM{constructor(e,t=0){this.step=e,this.origin=t}constrain(e){const t=this.origin%this.step,n=Math.round((e-t)/this.step);return t+n*this.step}}class rM{constructor(e){this.text=e}evaluate(){return Number(this.text)}toString(){return this.text}}const oM={"**":(i,e)=>Math.pow(i,e),"*":(i,e)=>i*e,"/":(i,e)=>i/e,"%":(i,e)=>i%e,"+":(i,e)=>i+e,"-":(i,e)=>i-e,"<<":(i,e)=>i<<e,">>":(i,e)=>i>>e,">>>":(i,e)=>i>>>e,"&":(i,e)=>i&e,"^":(i,e)=>i^e,"|":(i,e)=>i|e};class aM{constructor(e,t,n){this.left=t,this.operator=e,this.right=n}evaluate(){const e=oM[this.operator];if(!e)throw new Error(`unexpected binary operator: '${this.operator}`);return e(this.left.evaluate(),this.right.evaluate())}toString(){return["b(",this.left.toString(),this.operator,this.right.toString(),")"].join(" ")}}const lM={"+":i=>i,"-":i=>-i,"~":i=>~i};class cM{constructor(e,t){this.operator=e,this.expression=t}evaluate(){const e=lM[this.operator];if(!e)throw new Error(`unexpected unary operator: '${this.operator}`);return e(this.expression.evaluate())}toString(){return["u(",this.operator,this.expression.toString(),")"].join(" ")}}function wc(i){return(e,t)=>{for(let n=0;n<i.length;n++){const s=i[n](e,t);if(s!=="")return s}return""}}function Mr(i,e){var t;const n=i.substr(e).match(/^\s+/);return(t=n&&n[0])!==null&&t!==void 0?t:""}function hM(i,e){const t=i.substr(e,1);return t.match(/^[1-9]$/)?t:""}function Sr(i,e){var t;const n=i.substr(e).match(/^[0-9]+/);return(t=n&&n[0])!==null&&t!==void 0?t:""}function uM(i,e){const t=Sr(i,e);if(t!=="")return t;const n=i.substr(e,1);if(e+=1,n!=="-"&&n!=="+")return"";const s=Sr(i,e);return s===""?"":n+s}function Tc(i,e){const t=i.substr(e,1);if(e+=1,t.toLowerCase()!=="e")return"";const n=uM(i,e);return n===""?"":t+n}function nf(i,e){const t=i.substr(e,1);if(t==="0")return t;const n=hM(i,e);return e+=n.length,n===""?"":n+Sr(i,e)}function dM(i,e){const t=nf(i,e);if(e+=t.length,t==="")return"";const n=i.substr(e,1);if(e+=n.length,n!==".")return"";const s=Sr(i,e);return e+=s.length,t+n+s+Tc(i,e)}function fM(i,e){const t=i.substr(e,1);if(e+=t.length,t!==".")return"";const n=Sr(i,e);return e+=n.length,n===""?"":t+n+Tc(i,e)}function pM(i,e){const t=nf(i,e);return e+=t.length,t===""?"":t+Tc(i,e)}const mM=wc([dM,fM,pM]);function gM(i,e){var t;const n=i.substr(e).match(/^[01]+/);return(t=n&&n[0])!==null&&t!==void 0?t:""}function _M(i,e){const t=i.substr(e,2);if(e+=t.length,t.toLowerCase()!=="0b")return"";const n=gM(i,e);return n===""?"":t+n}function vM(i,e){var t;const n=i.substr(e).match(/^[0-7]+/);return(t=n&&n[0])!==null&&t!==void 0?t:""}function xM(i,e){const t=i.substr(e,2);if(e+=t.length,t.toLowerCase()!=="0o")return"";const n=vM(i,e);return n===""?"":t+n}function bM(i,e){var t;const n=i.substr(e).match(/^[0-9a-f]+/i);return(t=n&&n[0])!==null&&t!==void 0?t:""}function yM(i,e){const t=i.substr(e,2);if(e+=t.length,t.toLowerCase()!=="0x")return"";const n=bM(i,e);return n===""?"":t+n}const MM=wc([_M,xM,yM]),SM=wc([MM,mM]);function EM(i,e){const t=SM(i,e);return e+=t.length,t===""?null:{evaluable:new rM(t),cursor:e}}function wM(i,e){const t=i.substr(e,1);if(e+=t.length,t!=="(")return null;const n=rf(i,e);if(!n)return null;e=n.cursor,e+=Mr(i,e).length;const s=i.substr(e,1);return e+=s.length,s!==")"?null:{evaluable:n.evaluable,cursor:e}}function TM(i,e){var t;return(t=EM(i,e))!==null&&t!==void 0?t:wM(i,e)}function sf(i,e){const t=TM(i,e);if(t)return t;const n=i.substr(e,1);if(e+=n.length,n!=="+"&&n!=="-"&&n!=="~")return null;const s=sf(i,e);return s?(e=s.cursor,{cursor:e,evaluable:new cM(n,s.evaluable)}):null}function AM(i,e,t){t+=Mr(e,t).length;const n=i.filter(s=>e.startsWith(s,t))[0];return n?(t+=n.length,t+=Mr(e,t).length,{cursor:t,operator:n}):null}function CM(i,e){return(t,n)=>{const s=i(t,n);if(!s)return null;n=s.cursor;let r=s.evaluable;for(;;){const o=AM(e,t,n);if(!o)break;n=o.cursor;const a=i(t,n);if(!a)return null;n=a.cursor,r=new aM(o.operator,r,a.evaluable)}return r?{cursor:n,evaluable:r}:null}}const RM=[["**"],["*","/","%"],["+","-"],["<<",">>>",">>"],["&"],["^"],["|"]].reduce((i,e)=>CM(i,e),sf);function rf(i,e){return e+=Mr(i,e).length,RM(i,e)}function PM(i){const e=rf(i,0);return!e||e.cursor+Mr(i,e.cursor).length!==i.length?null:e.evaluable}function bi(i){var e;const t=PM(i);return(e=t?.evaluate())!==null&&e!==void 0?e:null}function of(i){if(typeof i=="number")return i;if(typeof i=="string"){const e=bi(i);if(!mt(e))return e}return 0}function Zt(i){return e=>e.toFixed(Math.max(Math.min(i,20),0))}function Qe(i,e,t,n,s){const r=(i-e)/(t-e);return n+r*(s-n)}function Pu(i){return String(i.toFixed(10)).split(".")[1].replace(/0+$/,"").length}function Mt(i,e,t){return Math.min(Math.max(i,e),t)}function af(i,e){return(i%e+e)%e}function IM(i,e){return mt(i.step)?Math.max(Pu(e),2):Pu(i.step)}function lf(i){var e;return(e=i.step)!==null&&e!==void 0?e:1}function LM(i,e){var t;const n=Math.abs((t=i.step)!==null&&t!==void 0?t:e);return n===0?.1:Math.pow(10,Math.floor(Math.log10(n))-1)}function cf(i,e){return mt(i.step)?null:new sM(i.step,e)}function hf(i){return!mt(i.max)&&!mt(i.min)?new Wo({max:i.max,min:i.min}):!mt(i.max)||!mt(i.min)?new iM({max:i.max,min:i.min}):null}function uf(i,e){var t,n,s;return{formatter:(t=i.format)!==null&&t!==void 0?t:Zt(IM(i,e)),keyScale:(n=i.keyScale)!==null&&n!==void 0?n:lf(i),pointerScale:(s=i.pointerScale)!==null&&s!==void 0?s:LM(i,e)}}function df(i){return{format:i.optional.function,keyScale:i.optional.number,max:i.optional.number,min:i.optional.number,pointerScale:i.optional.number,step:i.optional.number}}function Ac(i){return{constraint:i.constraint,textProps:qe.fromObject(uf(i.params,i.initialValue))}}class Cc{constructor(e){this.controller=e}get element(){return this.controller.view.element}get disabled(){return this.controller.viewProps.get("disabled")}set disabled(e){this.controller.viewProps.set("disabled",e)}get hidden(){return this.controller.viewProps.get("hidden")}set hidden(e){this.controller.viewProps.set("hidden",e)}dispose(){this.controller.viewProps.set("disposed",!0)}importState(e){return this.controller.importState(e)}exportState(){return this.controller.exportState()}}class Xo{constructor(e){this.target=e}}class ff extends Xo{constructor(e,t,n){super(e),this.value=t,this.last=n??!0}}class DM extends Xo{constructor(e,t){super(e),this.expanded=t}}class NM extends Xo{constructor(e,t){super(e),this.index=t}}class UM extends Xo{constructor(e,t){super(e),this.native=t}}class Rc extends Cc{constructor(e){super(e),this.onValueChange_=this.onValueChange_.bind(this),this.emitter_=new an,this.controller.value.emitter.on("change",this.onValueChange_)}get label(){return this.controller.labelController.props.get("label")}set label(e){this.controller.labelController.props.set("label",e)}get key(){return this.controller.value.binding.target.key}get tag(){return this.controller.tag}set tag(e){this.controller.tag=e}on(e,t){const n=t.bind(this);return this.emitter_.on(e,s=>{n(s)},{key:t}),this}off(e,t){return this.emitter_.off(e,t),this}refresh(){this.controller.value.fetch()}onValueChange_(e){const t=this.controller.value;this.emitter_.emit("change",new ff(this,t.binding.target.read(),e.options.last))}}function FM(i,e){const n=Object.keys(e).reduce((s,r)=>{if(s===void 0)return;const o=e[r],a=o(i[r]);return a.succeeded?Object.assign(Object.assign({},s),{[r]:a.value}):void 0},{});return n}function OM(i,e){return i.reduce((t,n)=>{if(t===void 0)return;const s=e(n);if(!(!s.succeeded||s.value===void 0))return[...t,s.value]},[])}function BM(i){return i===null?!1:typeof i=="object"}function Xn(i){return e=>t=>{if(!e&&t===void 0)return{succeeded:!1,value:void 0};if(e&&t===void 0)return{succeeded:!0,value:void 0};const n=i(t);return n!==void 0?{succeeded:!0,value:n}:{succeeded:!1,value:void 0}}}function Iu(i){return{custom:e=>Xn(e)(i),boolean:Xn(e=>typeof e=="boolean"?e:void 0)(i),number:Xn(e=>typeof e=="number"?e:void 0)(i),string:Xn(e=>typeof e=="string"?e:void 0)(i),function:Xn(e=>typeof e=="function"?e:void 0)(i),constant:e=>Xn(t=>t===e?e:void 0)(i),raw:Xn(e=>e)(i),object:e=>Xn(t=>{if(BM(t))return FM(t,e)})(i),array:e=>Xn(t=>{if(Array.isArray(t))return OM(t,e)})(i)}}const Xl={optional:Iu(!0),required:Iu(!1)};function Nt(i,e){const t=e(Xl),n=Xl.required.object(t)(i);return n.succeeded?n.value:void 0}function Fn(i,e,t,n){if(e&&!e(i))return!1;const s=Nt(i,t);return s?n(s):!1}function On(i,e){var t;return Oi((t=i?.())!==null&&t!==void 0?t:{},e)}function wo(i){return"value"in i}function kM(i){if(!Ec(i)||!("binding"in i))return!1;const e=i.binding;return Zy(e)}const Pn="http://www.w3.org/2000/svg";function Oo(i){i.offsetHeight}function VM(i,e){const t=i.style.transition;i.style.transition="none",e(),i.style.transition=t}function Pc(i){return i.ontouchstart!==void 0}function zM(i){const e=i.ownerDocument.defaultView;return e&&"document"in e?i.getContext("2d",{willReadFrequently:!0}):null}const HM={check:'<path d="M2 8l4 4l8 -8"/>',dropdown:'<path d="M5 7h6l-3 3 z"/>',p2dpad:'<path d="M8 4v8"/><path d="M4 8h8"/><circle cx="12" cy="12" r="1.2"/>'};function jo(i,e){const t=i.createElementNS(Pn,"svg");return t.innerHTML=HM[e],t}function pf(i,e,t){i.insertBefore(e,i.children[t])}function Ic(i){i.parentElement&&i.parentElement.removeChild(i)}function mf(i){for(;i.children.length>0;)i.removeChild(i.children[0])}function GM(i){for(;i.childNodes.length>0;)i.removeChild(i.childNodes[0])}function gf(i){return i.relatedTarget?i.relatedTarget:"explicitOriginalTarget"in i?i.explicitOriginalTarget:null}function Jn(i,e){i.emitter.on("change",t=>{e(t.rawValue)}),e(i.rawValue)}function Ln(i,e,t){Jn(i.value(e),t)}const WM="tp";function Ye(i){return(t,n)=>[WM,"-",i,"v",t?`_${t}`:"",n?`-${n}`:""].join("")}const ir=Ye("lbl");function XM(i,e){const t=i.createDocumentFragment();return e.split(`
`).map(s=>i.createTextNode(s)).forEach((s,r)=>{r>0&&t.appendChild(i.createElement("br")),t.appendChild(s)}),t}class jM{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(ir()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(ir("l")),Ln(t.props,"label",r=>{mt(r)?this.element.classList.add(ir(void 0,"nol")):(this.element.classList.remove(ir(void 0,"nol")),GM(n),n.appendChild(XM(e,r)))}),this.element.appendChild(n),this.labelElement=n;const s=e.createElement("div");s.classList.add(ir("v")),this.element.appendChild(s),this.valueElement=s}}class KM{constructor(e,t){this.props=t.props,this.valueController=t.valueController,this.viewProps=t.valueController.viewProps,this.view=new jM(e,{props:t.props,viewProps:this.viewProps}),this.view.valueElement.appendChild(this.valueController.view.element)}importProps(e){return Fn(e,null,t=>({label:t.optional.string}),t=>(this.props.set("label",t.label),!0))}exportProps(){return On(null,{label:this.props.get("label")})}}function qM(){return["veryfirst","first","last","verylast"]}const Lu=Ye(""),Du={veryfirst:"vfst",first:"fst",last:"lst",verylast:"vlst"};class _f{constructor(e){this.parent_=null,this.blade=e.blade,this.view=e.view,this.viewProps=e.viewProps;const t=this.view.element;this.blade.value("positions").emitter.on("change",()=>{qM().forEach(n=>{t.classList.remove(Lu(void 0,Du[n]))}),this.blade.get("positions").forEach(n=>{t.classList.add(Lu(void 0,Du[n]))})}),this.viewProps.handleDispose(()=>{Ic(t)})}get parent(){return this.parent_}set parent(e){this.parent_=e,this.viewProps.set("parent",this.parent_?this.parent_.viewProps:null)}importState(e){return Fn(e,null,t=>({disabled:t.required.boolean,hidden:t.required.boolean}),t=>(this.viewProps.importState(t),!0))}exportState(){return On(null,Object.assign({},this.viewProps.exportState()))}}class YM extends Cc{get label(){return this.controller.labelController.props.get("label")}set label(e){this.controller.labelController.props.set("label",e)}get title(){var e;return(e=this.controller.buttonController.props.get("title"))!==null&&e!==void 0?e:""}set title(e){this.controller.buttonController.props.set("title",e)}on(e,t){const n=t.bind(this);return this.controller.buttonController.emitter.on(e,r=>{n(new UM(this,r.nativeEvent))}),this}off(e,t){return this.controller.buttonController.emitter.off(e,t),this}}function $M(i,e,t){t?i.classList.add(e):i.classList.remove(e)}function ks(i,e){return t=>{$M(i,e,t)}}function Lc(i,e){Jn(i,t=>{e.textContent=t??""})}const Ha=Ye("btn");class ZM{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(Ha()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("button");n.classList.add(Ha("b")),t.viewProps.bindDisabled(n),this.element.appendChild(n),this.buttonElement=n;const s=e.createElement("div");s.classList.add(Ha("t")),Lc(t.props.value("title"),s),this.buttonElement.appendChild(s)}}class JM{constructor(e,t){this.emitter=new an,this.onClick_=this.onClick_.bind(this),this.props=t.props,this.viewProps=t.viewProps,this.view=new ZM(e,{props:this.props,viewProps:this.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}importProps(e){return Fn(e,null,t=>({title:t.optional.string}),t=>(this.props.set("title",t.title),!0))}exportProps(){return On(null,{title:this.props.get("title")})}onClick_(e){this.emitter.emit("click",{nativeEvent:e,sender:this})}}class Nu extends _f{constructor(e,t){const n=new JM(e,{props:t.buttonProps,viewProps:t.viewProps}),s=new KM(e,{blade:t.blade,props:t.labelProps,valueController:n});super({blade:t.blade,view:s.view,viewProps:t.viewProps}),this.buttonController=n,this.labelController=s}importState(e){return Fn(e,t=>super.importState(t)&&this.buttonController.importProps(t)&&this.labelController.importProps(t),()=>({}),()=>!0)}exportState(){return On(()=>super.exportState(),Object.assign(Object.assign({},this.buttonController.exportProps()),this.labelController.exportProps()))}}class vf{constructor(e){const[t,n]=e.split("-"),s=t.split(".");this.major=parseInt(s[0],10),this.minor=parseInt(s[1],10),this.patch=parseInt(s[2],10),this.prerelease=n??null}toString(){const e=[this.major,this.minor,this.patch].join(".");return this.prerelease!==null?[e,this.prerelease].join("-"):e}}const QM=new vf("2.0.5");function Gt(i){return Object.assign({core:QM},i)}Gt({id:"button",type:"blade",accept(i){const e=Nt(i,t=>({title:t.required.string,view:t.required.constant("button"),label:t.optional.string}));return e?{params:e}:null},controller(i){return new Nu(i.document,{blade:i.blade,buttonProps:qe.fromObject({title:i.params.title}),labelProps:qe.fromObject({label:i.params.label}),viewProps:i.viewProps})},api(i){return i.controller instanceof Nu?new YM(i.controller):null}});function eS(i,e){return i.addBlade(Object.assign(Object.assign({},e),{view:"button"}))}function tS(i,e){return i.addBlade(Object.assign(Object.assign({},e),{view:"folder"}))}function nS(i,e){return i.addBlade(Object.assign(Object.assign({},e),{view:"tab"}))}function iS(i){return Ec(i)?"refresh"in i&&typeof i.refresh=="function":!1}function sS(i,e){if(!Fo.isBindable(i))throw rn.notBindable();return new Fo(i,e)}class rS{constructor(e,t){this.onRackValueChange_=this.onRackValueChange_.bind(this),this.controller_=e,this.emitter_=new an,this.pool_=t,this.controller_.rack.emitter.on("valuechange",this.onRackValueChange_)}get children(){return this.controller_.rack.children.map(e=>this.pool_.createApi(e))}addBinding(e,t,n){const s=n??{},r=this.controller_.element.ownerDocument,o=this.pool_.createBinding(r,sS(e,t),s),a=this.pool_.createBindingApi(o);return this.add(a,s.index)}addFolder(e){return tS(this,e)}addButton(e){return eS(this,e)}addTab(e){return nS(this,e)}add(e,t){const n=e.controller;return this.controller_.rack.add(n,t),e}remove(e){this.controller_.rack.remove(e.controller)}addBlade(e){const t=this.controller_.element.ownerDocument,n=this.pool_.createBlade(t,e),s=this.pool_.createApi(n);return this.add(s,e.index)}on(e,t){const n=t.bind(this);return this.emitter_.on(e,s=>{n(s)},{key:t}),this}off(e,t){return this.emitter_.off(e,t),this}refresh(){this.children.forEach(e=>{iS(e)&&e.refresh()})}onRackValueChange_(e){const t=e.bladeController,n=this.pool_.createApi(t),s=kM(t.value)?t.value.binding:null;this.emitter_.emit("change",new ff(n,s?s.target.read():t.value.rawValue,e.options.last))}}class Dc extends Cc{constructor(e,t){super(e),this.rackApi_=new rS(e.rackController,t)}refresh(){this.rackApi_.refresh()}}class Nc extends _f{constructor(e){super({blade:e.blade,view:e.view,viewProps:e.rackController.viewProps}),this.rackController=e.rackController}importState(e){return Fn(e,t=>super.importState(t),t=>({children:t.required.array(t.required.raw)}),t=>this.rackController.rack.children.every((n,s)=>n.importState(t.children[s])))}exportState(){return On(()=>super.exportState(),{children:this.rackController.rack.children.map(e=>e.exportState())})}}function jl(i){return"rackController"in i}class oS{constructor(e){this.emitter=new an,this.items_=[],this.cache_=new Set,this.onSubListAdd_=this.onSubListAdd_.bind(this),this.onSubListRemove_=this.onSubListRemove_.bind(this),this.extract_=e}get items(){return this.items_}allItems(){return Array.from(this.cache_)}find(e){for(const t of this.allItems())if(e(t))return t;return null}includes(e){return this.cache_.has(e)}add(e,t){if(this.includes(e))throw rn.shouldNeverHappen();const n=t!==void 0?t:this.items_.length;this.items_.splice(n,0,e),this.cache_.add(e);const s=this.extract_(e);s&&(s.emitter.on("add",this.onSubListAdd_),s.emitter.on("remove",this.onSubListRemove_),s.allItems().forEach(r=>{this.cache_.add(r)})),this.emitter.emit("add",{index:n,item:e,root:this,target:this})}remove(e){const t=this.items_.indexOf(e);if(t<0)return;this.items_.splice(t,1),this.cache_.delete(e);const n=this.extract_(e);n&&(n.allItems().forEach(s=>{this.cache_.delete(s)}),n.emitter.off("add",this.onSubListAdd_),n.emitter.off("remove",this.onSubListRemove_)),this.emitter.emit("remove",{index:t,item:e,root:this,target:this})}onSubListAdd_(e){this.cache_.add(e.item),this.emitter.emit("add",{index:e.index,item:e.item,root:this,target:e.target})}onSubListRemove_(e){this.cache_.delete(e.item),this.emitter.emit("remove",{index:e.index,item:e.item,root:this,target:e.target})}}function aS(i,e){for(let t=0;t<i.length;t++){const n=i[t];if(wo(n)&&n.value===e)return n}return null}function lS(i){return jl(i)?i.rackController.rack.bcSet_:null}class cS{constructor(e){var t,n;this.emitter=new an,this.onBladePositionsChange_=this.onBladePositionsChange_.bind(this),this.onSetAdd_=this.onSetAdd_.bind(this),this.onSetRemove_=this.onSetRemove_.bind(this),this.onChildDispose_=this.onChildDispose_.bind(this),this.onChildPositionsChange_=this.onChildPositionsChange_.bind(this),this.onChildValueChange_=this.onChildValueChange_.bind(this),this.onChildViewPropsChange_=this.onChildViewPropsChange_.bind(this),this.onRackLayout_=this.onRackLayout_.bind(this),this.onRackValueChange_=this.onRackValueChange_.bind(this),this.blade_=(t=e.blade)!==null&&t!==void 0?t:null,(n=this.blade_)===null||n===void 0||n.value("positions").emitter.on("change",this.onBladePositionsChange_),this.viewProps=e.viewProps,this.bcSet_=new oS(lS),this.bcSet_.emitter.on("add",this.onSetAdd_),this.bcSet_.emitter.on("remove",this.onSetRemove_)}get children(){return this.bcSet_.items}add(e,t){var n;(n=e.parent)===null||n===void 0||n.remove(e),e.parent=this,this.bcSet_.add(e,t)}remove(e){e.parent=null,this.bcSet_.remove(e)}find(e){return this.bcSet_.allItems().filter(e)}onSetAdd_(e){this.updatePositions_();const t=e.target===e.root;if(this.emitter.emit("add",{bladeController:e.item,index:e.index,root:t,sender:this}),!t)return;const n=e.item;if(n.viewProps.emitter.on("change",this.onChildViewPropsChange_),n.blade.value("positions").emitter.on("change",this.onChildPositionsChange_),n.viewProps.handleDispose(this.onChildDispose_),wo(n))n.value.emitter.on("change",this.onChildValueChange_);else if(jl(n)){const s=n.rackController.rack;if(s){const r=s.emitter;r.on("layout",this.onRackLayout_),r.on("valuechange",this.onRackValueChange_)}}}onSetRemove_(e){this.updatePositions_();const t=e.target===e.root;if(this.emitter.emit("remove",{bladeController:e.item,root:t,sender:this}),!t)return;const n=e.item;if(wo(n))n.value.emitter.off("change",this.onChildValueChange_);else if(jl(n)){const s=n.rackController.rack;if(s){const r=s.emitter;r.off("layout",this.onRackLayout_),r.off("valuechange",this.onRackValueChange_)}}}updatePositions_(){const e=this.bcSet_.items.filter(s=>!s.viewProps.get("hidden")),t=e[0],n=e[e.length-1];this.bcSet_.items.forEach(s=>{const r=[];s===t&&(r.push("first"),(!this.blade_||this.blade_.get("positions").includes("veryfirst"))&&r.push("veryfirst")),s===n&&(r.push("last"),(!this.blade_||this.blade_.get("positions").includes("verylast"))&&r.push("verylast")),s.blade.set("positions",r)})}onChildPositionsChange_(){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildViewPropsChange_(e){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildDispose_(){this.bcSet_.items.filter(t=>t.viewProps.get("disposed")).forEach(t=>{this.bcSet_.remove(t)})}onChildValueChange_(e){const t=aS(this.find(wo),e.sender);if(!t)throw rn.alreadyDisposed();this.emitter.emit("valuechange",{bladeController:t,options:e.options,sender:this})}onRackLayout_(e){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onRackValueChange_(e){this.emitter.emit("valuechange",{bladeController:e.bladeController,options:e.options,sender:this})}onBladePositionsChange_(){this.updatePositions_()}}class Uc{constructor(e){this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this),this.element=e.element,this.viewProps=e.viewProps;const t=new cS({blade:e.root?void 0:e.blade,viewProps:e.viewProps});t.emitter.on("add",this.onRackAdd_),t.emitter.on("remove",this.onRackRemove_),this.rack=t,this.viewProps.handleDispose(()=>{for(let n=this.rack.children.length-1;n>=0;n--)this.rack.children[n].viewProps.set("disposed",!0)})}onRackAdd_(e){e.root&&pf(this.element,e.bladeController.view.element,e.index)}onRackRemove_(e){e.root&&Ic(e.bladeController.view.element)}}function xf(){return new qe({positions:Pt([],{equals:$y})})}class Pr extends qe{constructor(e){super(e)}static create(e){const t={completed:!0,expanded:e,expandedHeight:null,shouldFixHeight:!1,temporaryExpanded:null},n=qe.createCore(t);return new Pr(n)}get styleExpanded(){var e;return(e=this.get("temporaryExpanded"))!==null&&e!==void 0?e:this.get("expanded")}get styleHeight(){if(!this.styleExpanded)return"0";const e=this.get("expandedHeight");return this.get("shouldFixHeight")&&!mt(e)?`${e}px`:"auto"}bindExpandedClass(e,t){const n=()=>{this.styleExpanded?e.classList.add(t):e.classList.remove(t)};Ln(this,"expanded",n),Ln(this,"temporaryExpanded",n)}cleanUpTransition(){this.set("shouldFixHeight",!1),this.set("expandedHeight",null),this.set("completed",!0)}}function hS(i,e){let t=0;return VM(e,()=>{i.set("expandedHeight",null),i.set("temporaryExpanded",!0),Oo(e),t=e.clientHeight,i.set("temporaryExpanded",null),Oo(e)}),t}function Uu(i,e){e.style.height=i.styleHeight}function Fc(i,e){i.value("expanded").emitter.on("beforechange",()=>{if(i.set("completed",!1),mt(i.get("expandedHeight"))){const t=hS(i,e);t>0&&i.set("expandedHeight",t)}i.set("shouldFixHeight",!0),Oo(e)}),i.emitter.on("change",()=>{Uu(i,e)}),Uu(i,e),e.addEventListener("transitionend",t=>{t.propertyName==="height"&&i.cleanUpTransition()})}class uS extends Dc{constructor(e,t){super(e,t),this.emitter_=new an,this.controller.foldable.value("expanded").emitter.on("change",n=>{this.emitter_.emit("fold",new DM(this,n.sender.rawValue))}),this.rackApi_.on("change",n=>{this.emitter_.emit("change",n)})}get expanded(){return this.controller.foldable.get("expanded")}set expanded(e){this.controller.foldable.set("expanded",e)}get title(){return this.controller.props.get("title")}set title(e){this.controller.props.set("title",e)}get children(){return this.rackApi_.children}addBinding(e,t,n){return this.rackApi_.addBinding(e,t,n)}addFolder(e){return this.rackApi_.addFolder(e)}addButton(e){return this.rackApi_.addButton(e)}addTab(e){return this.rackApi_.addTab(e)}add(e,t){return this.rackApi_.add(e,t)}remove(e){this.rackApi_.remove(e)}addBlade(e){return this.rackApi_.addBlade(e)}on(e,t){const n=t.bind(this);return this.emitter_.on(e,s=>{n(s)},{key:t}),this}off(e,t){return this.emitter_.off(e,t),this}}const bf=Ye("cnt");class dS{constructor(e,t){var n;this.className_=Ye((n=t.viewName)!==null&&n!==void 0?n:"fld"),this.element=e.createElement("div"),this.element.classList.add(this.className_(),bf()),t.viewProps.bindClassModifiers(this.element),this.foldable_=t.foldable,this.foldable_.bindExpandedClass(this.element,this.className_(void 0,"expanded")),Ln(this.foldable_,"completed",ks(this.element,this.className_(void 0,"cpl")));const s=e.createElement("button");s.classList.add(this.className_("b")),Ln(t.props,"title",c=>{mt(c)?this.element.classList.add(this.className_(void 0,"not")):this.element.classList.remove(this.className_(void 0,"not"))}),t.viewProps.bindDisabled(s),this.element.appendChild(s),this.buttonElement=s;const r=e.createElement("div");r.classList.add(this.className_("i")),this.element.appendChild(r);const o=e.createElement("div");o.classList.add(this.className_("t")),Lc(t.props.value("title"),o),this.buttonElement.appendChild(o),this.titleElement=o;const a=e.createElement("div");a.classList.add(this.className_("m")),this.buttonElement.appendChild(a);const l=e.createElement("div");l.classList.add(this.className_("c")),this.element.appendChild(l),this.containerElement=l}}class Fu extends Nc{constructor(e,t){var n;const s=Pr.create((n=t.expanded)!==null&&n!==void 0?n:!0),r=new dS(e,{foldable:s,props:t.props,viewName:t.root?"rot":void 0,viewProps:t.viewProps});super(Object.assign(Object.assign({},t),{rackController:new Uc({blade:t.blade,element:r.containerElement,root:t.root,viewProps:t.viewProps}),view:r})),this.onTitleClick_=this.onTitleClick_.bind(this),this.props=t.props,this.foldable=s,Fc(this.foldable,this.view.containerElement),this.rackController.rack.emitter.on("add",()=>{this.foldable.cleanUpTransition()}),this.rackController.rack.emitter.on("remove",()=>{this.foldable.cleanUpTransition()}),this.view.buttonElement.addEventListener("click",this.onTitleClick_)}get document(){return this.view.element.ownerDocument}importState(e){return Fn(e,t=>super.importState(t),t=>({expanded:t.required.boolean,title:t.optional.string}),t=>(this.foldable.set("expanded",t.expanded),this.props.set("title",t.title),!0))}exportState(){return On(()=>super.exportState(),{expanded:this.foldable.get("expanded"),title:this.props.get("title")})}onTitleClick_(){this.foldable.set("expanded",!this.foldable.get("expanded"))}}Gt({id:"folder",type:"blade",accept(i){const e=Nt(i,t=>({title:t.required.string,view:t.required.constant("folder"),expanded:t.optional.boolean}));return e?{params:e}:null},controller(i){return new Fu(i.document,{blade:i.blade,expanded:i.params.expanded,props:qe.fromObject({title:i.params.title}),viewProps:i.viewProps})},api(i){return i.controller instanceof Fu?new uS(i.controller,i.pool):null}});const fS=Ye("");function Ou(i,e){return ks(i,fS(void 0,e))}class Ir extends qe{constructor(e){var t;super(e),this.onDisabledChange_=this.onDisabledChange_.bind(this),this.onParentChange_=this.onParentChange_.bind(this),this.onParentGlobalDisabledChange_=this.onParentGlobalDisabledChange_.bind(this),[this.globalDisabled_,this.setGlobalDisabled_]=nM(Pt(this.getGlobalDisabled_())),this.value("disabled").emitter.on("change",this.onDisabledChange_),this.value("parent").emitter.on("change",this.onParentChange_),(t=this.get("parent"))===null||t===void 0||t.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_)}static create(e){var t,n,s;const r=e??{};return new Ir(qe.createCore({disabled:(t=r.disabled)!==null&&t!==void 0?t:!1,disposed:!1,hidden:(n=r.hidden)!==null&&n!==void 0?n:!1,parent:(s=r.parent)!==null&&s!==void 0?s:null}))}get globalDisabled(){return this.globalDisabled_}bindClassModifiers(e){Jn(this.globalDisabled_,Ou(e,"disabled")),Ln(this,"hidden",Ou(e,"hidden"))}bindDisabled(e){Jn(this.globalDisabled_,t=>{e.disabled=t})}bindTabIndex(e){Jn(this.globalDisabled_,t=>{e.tabIndex=t?-1:0})}handleDispose(e){this.value("disposed").emitter.on("change",t=>{t&&e()})}importState(e){this.set("disabled",e.disabled),this.set("hidden",e.hidden)}exportState(){return{disabled:this.get("disabled"),hidden:this.get("hidden")}}getGlobalDisabled_(){const e=this.get("parent");return(e?e.globalDisabled.rawValue:!1)||this.get("disabled")}updateGlobalDisabled_(){this.setGlobalDisabled_(this.getGlobalDisabled_())}onDisabledChange_(){this.updateGlobalDisabled_()}onParentGlobalDisabledChange_(){this.updateGlobalDisabled_()}onParentChange_(e){var t;const n=e.previousRawValue;n?.globalDisabled.emitter.off("change",this.onParentGlobalDisabledChange_),(t=this.get("parent"))===null||t===void 0||t.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_),this.updateGlobalDisabled_()}}const Bu=Ye("tbp");class pS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(Bu()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(Bu("c")),this.element.appendChild(n),this.containerElement=n}}const sr=Ye("tbi");class mS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(sr()),t.viewProps.bindClassModifiers(this.element),Ln(t.props,"selected",r=>{r?this.element.classList.add(sr(void 0,"sel")):this.element.classList.remove(sr(void 0,"sel"))});const n=e.createElement("button");n.classList.add(sr("b")),t.viewProps.bindDisabled(n),this.element.appendChild(n),this.buttonElement=n;const s=e.createElement("div");s.classList.add(sr("t")),Lc(t.props.value("title"),s),this.buttonElement.appendChild(s),this.titleElement=s}}class gS{constructor(e,t){this.emitter=new an,this.onClick_=this.onClick_.bind(this),this.props=t.props,this.viewProps=t.viewProps,this.view=new mS(e,{props:t.props,viewProps:t.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}onClick_(){this.emitter.emit("click",{sender:this})}}class Kl extends Nc{constructor(e,t){const n=new pS(e,{viewProps:t.viewProps});super(Object.assign(Object.assign({},t),{rackController:new Uc({blade:t.blade,element:n.containerElement,viewProps:t.viewProps}),view:n})),this.onItemClick_=this.onItemClick_.bind(this),this.ic_=new gS(e,{props:t.itemProps,viewProps:Ir.create()}),this.ic_.emitter.on("click",this.onItemClick_),this.props=t.props,Ln(this.props,"selected",s=>{this.itemController.props.set("selected",s),this.viewProps.set("hidden",!s)})}get itemController(){return this.ic_}importState(e){return Fn(e,t=>super.importState(t),t=>({selected:t.required.boolean,title:t.required.string}),t=>(this.ic_.props.set("selected",t.selected),this.ic_.props.set("title",t.title),!0))}exportState(){return On(()=>super.exportState(),{selected:this.ic_.props.get("selected"),title:this.ic_.props.get("title")})}onItemClick_(){this.props.set("selected",!0)}}class _S extends Dc{constructor(e,t){super(e,t),this.emitter_=new an,this.onSelect_=this.onSelect_.bind(this),this.pool_=t,this.rackApi_.on("change",n=>{this.emitter_.emit("change",n)}),this.controller.tab.selectedIndex.emitter.on("change",this.onSelect_)}get pages(){return this.rackApi_.children}addPage(e){const t=this.controller.view.element.ownerDocument,n=new Kl(t,{blade:xf(),itemProps:qe.fromObject({selected:!1,title:e.title}),props:qe.fromObject({selected:!1}),viewProps:Ir.create()}),s=this.pool_.createApi(n);return this.rackApi_.add(s,e.index)}removePage(e){this.rackApi_.remove(this.rackApi_.children[e])}on(e,t){const n=t.bind(this);return this.emitter_.on(e,s=>{n(s)},{key:t}),this}off(e,t){return this.emitter_.off(e,t),this}onSelect_(e){this.emitter_.emit("select",new NM(this,e.rawValue))}}class vS extends Dc{get title(){var e;return(e=this.controller.itemController.props.get("title"))!==null&&e!==void 0?e:""}set title(e){this.controller.itemController.props.set("title",e)}get selected(){return this.controller.props.get("selected")}set selected(e){this.controller.props.set("selected",e)}get children(){return this.rackApi_.children}addButton(e){return this.rackApi_.addButton(e)}addFolder(e){return this.rackApi_.addFolder(e)}addTab(e){return this.rackApi_.addTab(e)}add(e,t){this.rackApi_.add(e,t)}remove(e){this.rackApi_.remove(e)}addBinding(e,t,n){return this.rackApi_.addBinding(e,t,n)}addBlade(e){return this.rackApi_.addBlade(e)}}const ku=-1;class xS{constructor(){this.onItemSelectedChange_=this.onItemSelectedChange_.bind(this),this.empty=Pt(!0),this.selectedIndex=Pt(ku),this.items_=[]}add(e,t){const n=t??this.items_.length;this.items_.splice(n,0,e),e.emitter.on("change",this.onItemSelectedChange_),this.keepSelection_()}remove(e){const t=this.items_.indexOf(e);t<0||(this.items_.splice(t,1),e.emitter.off("change",this.onItemSelectedChange_),this.keepSelection_())}keepSelection_(){if(this.items_.length===0){this.selectedIndex.rawValue=ku,this.empty.rawValue=!0;return}const e=this.items_.findIndex(t=>t.rawValue);e<0?(this.items_.forEach((t,n)=>{t.rawValue=n===0}),this.selectedIndex.rawValue=0):(this.items_.forEach((t,n)=>{t.rawValue=n===e}),this.selectedIndex.rawValue=e),this.empty.rawValue=!1}onItemSelectedChange_(e){if(e.rawValue){const t=this.items_.findIndex(n=>n===e.sender);this.items_.forEach((n,s)=>{n.rawValue=s===t}),this.selectedIndex.rawValue=t}else this.keepSelection_()}}const rr=Ye("tab");class bS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(rr(),bf()),t.viewProps.bindClassModifiers(this.element),Jn(t.empty,ks(this.element,rr(void 0,"nop")));const n=e.createElement("div");n.classList.add(rr("t")),this.element.appendChild(n),this.itemsElement=n;const s=e.createElement("div");s.classList.add(rr("i")),this.element.appendChild(s);const r=e.createElement("div");r.classList.add(rr("c")),this.element.appendChild(r),this.contentsElement=r}}class Vu extends Nc{constructor(e,t){const n=new xS,s=new bS(e,{empty:n.empty,viewProps:t.viewProps});super({blade:t.blade,rackController:new Uc({blade:t.blade,element:s.contentsElement,viewProps:t.viewProps}),view:s}),this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this);const r=this.rackController.rack;r.emitter.on("add",this.onRackAdd_),r.emitter.on("remove",this.onRackRemove_),this.tab=n}add(e,t){this.rackController.rack.add(e,t)}remove(e){this.rackController.rack.remove(this.rackController.rack.children[e])}onRackAdd_(e){if(!e.root)return;const t=e.bladeController;pf(this.view.itemsElement,t.itemController.view.element,e.index),t.itemController.viewProps.set("parent",this.viewProps),this.tab.add(t.props.value("selected"))}onRackRemove_(e){if(!e.root)return;const t=e.bladeController;Ic(t.itemController.view.element),t.itemController.viewProps.set("parent",null),this.tab.remove(t.props.value("selected"))}}Gt({id:"tab",type:"blade",accept(i){const e=Nt(i,t=>({pages:t.required.array(t.required.object({title:t.required.string})),view:t.required.constant("tab")}));return!e||e.pages.length===0?null:{params:e}},controller(i){const e=new Vu(i.document,{blade:i.blade,viewProps:i.viewProps});return i.params.pages.forEach(t=>{const n=new Kl(i.document,{blade:xf(),itemProps:qe.fromObject({selected:!1,title:t.title}),props:qe.fromObject({selected:!1}),viewProps:Ir.create()});e.add(n)}),e},api(i){return i.controller instanceof Vu?new _S(i.controller,i.pool):i.controller instanceof Kl?new vS(i.controller,i.pool):null}});class Oc extends Rc{get options(){return this.controller.valueController.props.get("options")}set options(e){this.controller.valueController.props.set("options",e)}}class Lr{constructor(e){this.constraints=e}constrain(e){return this.constraints.reduce((t,n)=>n.constrain(t),e)}}function Bo(i,e){if(i instanceof e)return i;if(i instanceof Lr){const t=i.constraints.reduce((n,s)=>n||(s instanceof e?s:null),null);if(t)return t}return null}class Ko{constructor(e){this.values=qe.fromObject({options:e})}constrain(e){const t=this.values.get("options");return t.length===0||t.filter(s=>s.value===e).length>0?e:t[0].value}}function qo(i){var e;const t=Xl;if(Array.isArray(i))return(e=Nt({items:i},n=>({items:n.required.array(n.required.object({text:n.required.string,value:n.required.raw}))})))===null||e===void 0?void 0:e.items;if(typeof i=="object")return t.required.raw(i).value}function yf(i){if(Array.isArray(i))return i;const e=[];return Object.keys(i).forEach(t=>{e.push({text:t,value:i[t]})}),e}function Bc(i){return mt(i)?null:new Ko(yf(i))}const Ga=Ye("lst");class yS{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),this.props_=t.props,this.element=e.createElement("div"),this.element.classList.add(Ga()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("select");n.classList.add(Ga("s")),t.viewProps.bindDisabled(n),this.element.appendChild(n),this.selectElement=n;const s=e.createElement("div");s.classList.add(Ga("m")),s.appendChild(jo(e,"dropdown")),this.element.appendChild(s),t.value.emitter.on("change",this.onValueChange_),this.value_=t.value,Ln(this.props_,"options",r=>{mf(this.selectElement),r.forEach(o=>{const a=e.createElement("option");a.textContent=o.text,this.selectElement.appendChild(a)}),this.update_()})}update_(){const e=this.props_.get("options").map(t=>t.value);this.selectElement.selectedIndex=e.indexOf(this.value_.rawValue)}onValueChange_(){this.update_()}}class Ns{constructor(e,t){this.onSelectChange_=this.onSelectChange_.bind(this),this.props=t.props,this.value=t.value,this.viewProps=t.viewProps,this.view=new yS(e,{props:this.props,value:this.value,viewProps:this.viewProps}),this.view.selectElement.addEventListener("change",this.onSelectChange_)}onSelectChange_(e){const t=e.currentTarget;this.value.rawValue=this.props.get("options")[t.selectedIndex].value}importProps(e){return Fn(e,null,t=>({options:t.required.custom(qo)}),t=>(this.props.set("options",yf(t.options)),!0))}exportProps(){return On(null,{options:this.props.get("options")})}}const zu=Ye("pop");class MS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(zu()),t.viewProps.bindClassModifiers(this.element),Jn(t.shows,ks(this.element,zu(void 0,"v")))}}class Mf{constructor(e,t){this.shows=Pt(!1),this.viewProps=t.viewProps,this.view=new MS(e,{shows:this.shows,viewProps:this.viewProps})}}const Hu=Ye("txt");class SS{constructor(e,t){this.onChange_=this.onChange_.bind(this),this.element=e.createElement("div"),this.element.classList.add(Hu()),t.viewProps.bindClassModifiers(this.element),this.props_=t.props,this.props_.emitter.on("change",this.onChange_);const n=e.createElement("input");n.classList.add(Hu("i")),n.type="text",t.viewProps.bindDisabled(n),this.element.appendChild(n),this.inputElement=n,t.value.emitter.on("change",this.onChange_),this.value_=t.value,this.refresh()}refresh(){const e=this.props_.get("formatter");this.inputElement.value=e(this.value_.rawValue)}onChange_(){this.refresh()}}class kc{constructor(e,t){this.onInputChange_=this.onInputChange_.bind(this),this.parser_=t.parser,this.props=t.props,this.value=t.value,this.viewProps=t.viewProps,this.view=new SS(e,{props:t.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_)}onInputChange_(e){const n=e.currentTarget.value,s=this.parser_(n);mt(s)||(this.value.rawValue=s),this.view.refresh()}}function ES(i){return String(i)}function Sf(i){return i==="false"?!1:!!i}function Gu(i){return ES(i)}function wS(i){return e=>i.reduce((t,n)=>t!==null?t:n(e),null)}const TS=Zt(0);function ko(i){return TS(i)+"%"}function Ef(i){return String(i)}function ql(i){return i}function Vs({primary:i,secondary:e,forward:t,backward:n}){let s=!1;function r(o){s||(s=!0,o(),s=!1)}i.emitter.on("change",o=>{r(()=>{e.setRawValue(t(i.rawValue,e.rawValue),o.options)})}),e.emitter.on("change",o=>{r(()=>{i.setRawValue(n(i.rawValue,e.rawValue),o.options)}),r(()=>{e.setRawValue(t(i.rawValue,e.rawValue),o.options)})}),r(()=>{e.setRawValue(t(i.rawValue,e.rawValue),{forceEmit:!1,last:!0})})}function Kt(i,e){const t=i*(e.altKey?.1:1)*(e.shiftKey?10:1);return e.upKey?+t:e.downKey?-t:0}function Er(i){return{altKey:i.altKey,downKey:i.key==="ArrowDown",shiftKey:i.shiftKey,upKey:i.key==="ArrowUp"}}function ei(i){return{altKey:i.altKey,downKey:i.key==="ArrowLeft",shiftKey:i.shiftKey,upKey:i.key==="ArrowRight"}}function AS(i){return i==="ArrowUp"||i==="ArrowDown"}function wf(i){return AS(i)||i==="ArrowLeft"||i==="ArrowRight"}function Wa(i,e){var t,n;const s=e.ownerDocument.defaultView,r=e.getBoundingClientRect();return{x:i.pageX-(((t=s&&s.scrollX)!==null&&t!==void 0?t:0)+r.left),y:i.pageY-(((n=s&&s.scrollY)!==null&&n!==void 0?n:0)+r.top)}}class Vi{constructor(e){this.lastTouch_=null,this.onDocumentMouseMove_=this.onDocumentMouseMove_.bind(this),this.onDocumentMouseUp_=this.onDocumentMouseUp_.bind(this),this.onMouseDown_=this.onMouseDown_.bind(this),this.onTouchEnd_=this.onTouchEnd_.bind(this),this.onTouchMove_=this.onTouchMove_.bind(this),this.onTouchStart_=this.onTouchStart_.bind(this),this.elem_=e,this.emitter=new an,e.addEventListener("touchstart",this.onTouchStart_,{passive:!1}),e.addEventListener("touchmove",this.onTouchMove_,{passive:!0}),e.addEventListener("touchend",this.onTouchEnd_),e.addEventListener("mousedown",this.onMouseDown_)}computePosition_(e){const t=this.elem_.getBoundingClientRect();return{bounds:{width:t.width,height:t.height},point:e?{x:e.x,y:e.y}:null}}onMouseDown_(e){var t;e.preventDefault(),(t=e.currentTarget)===null||t===void 0||t.focus();const n=this.elem_.ownerDocument;n.addEventListener("mousemove",this.onDocumentMouseMove_),n.addEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("down",{altKey:e.altKey,data:this.computePosition_(Wa(e,this.elem_)),sender:this,shiftKey:e.shiftKey})}onDocumentMouseMove_(e){this.emitter.emit("move",{altKey:e.altKey,data:this.computePosition_(Wa(e,this.elem_)),sender:this,shiftKey:e.shiftKey})}onDocumentMouseUp_(e){const t=this.elem_.ownerDocument;t.removeEventListener("mousemove",this.onDocumentMouseMove_),t.removeEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("up",{altKey:e.altKey,data:this.computePosition_(Wa(e,this.elem_)),sender:this,shiftKey:e.shiftKey})}onTouchStart_(e){e.preventDefault();const t=e.targetTouches.item(0),n=this.elem_.getBoundingClientRect();this.emitter.emit("down",{altKey:e.altKey,data:this.computePosition_(t?{x:t.clientX-n.left,y:t.clientY-n.top}:void 0),sender:this,shiftKey:e.shiftKey}),this.lastTouch_=t}onTouchMove_(e){const t=e.targetTouches.item(0),n=this.elem_.getBoundingClientRect();this.emitter.emit("move",{altKey:e.altKey,data:this.computePosition_(t?{x:t.clientX-n.left,y:t.clientY-n.top}:void 0),sender:this,shiftKey:e.shiftKey}),this.lastTouch_=t}onTouchEnd_(e){var t;const n=(t=e.targetTouches.item(0))!==null&&t!==void 0?t:this.lastTouch_,s=this.elem_.getBoundingClientRect();this.emitter.emit("up",{altKey:e.altKey,data:this.computePosition_(n?{x:n.clientX-s.left,y:n.clientY-s.top}:void 0),sender:this,shiftKey:e.shiftKey})}}const un=Ye("txt");class CS{constructor(e,t){this.onChange_=this.onChange_.bind(this),this.props_=t.props,this.props_.emitter.on("change",this.onChange_),this.element=e.createElement("div"),this.element.classList.add(un(),un(void 0,"num")),t.arrayPosition&&this.element.classList.add(un(void 0,t.arrayPosition)),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("input");n.classList.add(un("i")),n.type="text",t.viewProps.bindDisabled(n),this.element.appendChild(n),this.inputElement=n,this.onDraggingChange_=this.onDraggingChange_.bind(this),this.dragging_=t.dragging,this.dragging_.emitter.on("change",this.onDraggingChange_),this.element.classList.add(un()),this.inputElement.classList.add(un("i"));const s=e.createElement("div");s.classList.add(un("k")),this.element.appendChild(s),this.knobElement=s;const r=e.createElementNS(Pn,"svg");r.classList.add(un("g")),this.knobElement.appendChild(r);const o=e.createElementNS(Pn,"path");o.classList.add(un("gb")),r.appendChild(o),this.guideBodyElem_=o;const a=e.createElementNS(Pn,"path");a.classList.add(un("gh")),r.appendChild(a),this.guideHeadElem_=a;const l=e.createElement("div");l.classList.add(Ye("tt")()),this.knobElement.appendChild(l),this.tooltipElem_=l,t.value.emitter.on("change",this.onChange_),this.value=t.value,this.refresh()}onDraggingChange_(e){if(e.rawValue===null){this.element.classList.remove(un(void 0,"drg"));return}this.element.classList.add(un(void 0,"drg"));const t=e.rawValue/this.props_.get("pointerScale"),n=t+(t>0?-1:t<0?1:0),s=Mt(-n,-4,4);this.guideHeadElem_.setAttributeNS(null,"d",[`M ${n+s},0 L${n},4 L${n+s},8`,`M ${t},-1 L${t},9`].join(" ")),this.guideBodyElem_.setAttributeNS(null,"d",`M 0,4 L${t},4`);const r=this.props_.get("formatter");this.tooltipElem_.textContent=r(this.value.rawValue),this.tooltipElem_.style.left=`${t}px`}refresh(){const e=this.props_.get("formatter");this.inputElement.value=e(this.value.rawValue)}onChange_(){this.refresh()}}class Dr{constructor(e,t){var n;this.originRawValue_=0,this.onInputChange_=this.onInputChange_.bind(this),this.onInputKeyDown_=this.onInputKeyDown_.bind(this),this.onInputKeyUp_=this.onInputKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.parser_=t.parser,this.props=t.props,this.sliderProps_=(n=t.sliderProps)!==null&&n!==void 0?n:null,this.value=t.value,this.viewProps=t.viewProps,this.dragging_=Pt(null),this.view=new CS(e,{arrayPosition:t.arrayPosition,dragging:this.dragging_,props:this.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_),this.view.inputElement.addEventListener("keydown",this.onInputKeyDown_),this.view.inputElement.addEventListener("keyup",this.onInputKeyUp_);const s=new Vi(this.view.knobElement);s.emitter.on("down",this.onPointerDown_),s.emitter.on("move",this.onPointerMove_),s.emitter.on("up",this.onPointerUp_)}constrainValue_(e){var t,n;const s=(t=this.sliderProps_)===null||t===void 0?void 0:t.get("min"),r=(n=this.sliderProps_)===null||n===void 0?void 0:n.get("max");let o=e;return s!==void 0&&(o=Math.max(o,s)),r!==void 0&&(o=Math.min(o,r)),o}onInputChange_(e){const n=e.currentTarget.value,s=this.parser_(n);mt(s)||(this.value.rawValue=this.constrainValue_(s)),this.view.refresh()}onInputKeyDown_(e){const t=Kt(this.props.get("keyScale"),Er(e));t!==0&&this.value.setRawValue(this.constrainValue_(this.value.rawValue+t),{forceEmit:!1,last:!1})}onInputKeyUp_(e){Kt(this.props.get("keyScale"),Er(e))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}onPointerDown_(){this.originRawValue_=this.value.rawValue,this.dragging_.rawValue=0}computeDraggingValue_(e){if(!e.point)return null;const t=e.point.x-e.bounds.width/2;return this.constrainValue_(this.originRawValue_+t*this.props.get("pointerScale"))}onPointerMove_(e){const t=this.computeDraggingValue_(e.data);t!==null&&(this.value.setRawValue(t,{forceEmit:!1,last:!1}),this.dragging_.rawValue=this.value.rawValue-this.originRawValue_)}onPointerUp_(e){const t=this.computeDraggingValue_(e.data);t!==null&&(this.value.setRawValue(t,{forceEmit:!0,last:!0}),this.dragging_.rawValue=null)}}const Xa=Ye("sld");class RS{constructor(e,t){this.onChange_=this.onChange_.bind(this),this.props_=t.props,this.props_.emitter.on("change",this.onChange_),this.element=e.createElement("div"),this.element.classList.add(Xa()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(Xa("t")),t.viewProps.bindTabIndex(n),this.element.appendChild(n),this.trackElement=n;const s=e.createElement("div");s.classList.add(Xa("k")),this.trackElement.appendChild(s),this.knobElement=s,t.value.emitter.on("change",this.onChange_),this.value=t.value,this.update_()}update_(){const e=Mt(Qe(this.value.rawValue,this.props_.get("min"),this.props_.get("max"),0,100),0,100);this.knobElement.style.width=`${e}%`}onChange_(){this.update_()}}class PS{constructor(e,t){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDownOrMove_=this.onPointerDownOrMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.props=t.props,this.view=new RS(e,{props:this.props,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Vi(this.view.trackElement),this.ptHandler_.emitter.on("down",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("move",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.trackElement.addEventListener("keydown",this.onKeyDown_),this.view.trackElement.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(e,t){e.point&&this.value.setRawValue(Qe(Mt(e.point.x,0,e.bounds.width),0,e.bounds.width,this.props.get("min"),this.props.get("max")),t)}onPointerDownOrMove_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerUp_(e){this.handlePointerEvent_(e.data,{forceEmit:!0,last:!0})}onKeyDown_(e){const t=Kt(this.props.get("keyScale"),ei(e));t!==0&&this.value.setRawValue(this.value.rawValue+t,{forceEmit:!1,last:!1})}onKeyUp_(e){Kt(this.props.get("keyScale"),ei(e))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const ja=Ye("sldtxt");class IS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(ja());const n=e.createElement("div");n.classList.add(ja("s")),this.sliderView_=t.sliderView,n.appendChild(this.sliderView_.element),this.element.appendChild(n);const s=e.createElement("div");s.classList.add(ja("t")),this.textView_=t.textView,s.appendChild(this.textView_.element),this.element.appendChild(s)}}class Wu{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.sliderC_=new PS(e,{props:t.sliderProps,value:t.value,viewProps:this.viewProps}),this.textC_=new Dr(e,{parser:t.parser,props:t.textProps,sliderProps:t.sliderProps,value:t.value,viewProps:t.viewProps}),this.view=new IS(e,{sliderView:this.sliderC_.view,textView:this.textC_.view})}get sliderController(){return this.sliderC_}get textController(){return this.textC_}importProps(e){return Fn(e,null,t=>({max:t.required.number,min:t.required.number}),t=>{const n=this.sliderC_.props;return n.set("max",t.max),n.set("min",t.min),!0})}exportProps(){const e=this.sliderC_.props;return On(null,{max:e.get("max"),min:e.get("min")})}}function LS(i){return{sliderProps:new qe({keyScale:i.keyScale,max:i.max,min:i.min}),textProps:new qe({formatter:Pt(i.formatter),keyScale:i.keyScale,pointerScale:Pt(i.pointerScale)})}}const DS={containerUnitSize:"cnt-usz"};function Tf(i){return`--${DS[i]}`}function wr(i){return df(i)}function gi(i){if(Wl(i))return Nt(i,wr)}function $n(i,e){if(!i)return;const t=[],n=cf(i,e);n&&t.push(n);const s=hf(i);return s&&t.push(s),new Lr(t)}function Af(i){if(i==="inline"||i==="popup")return i}function Nr(i,e){i.write(e)}const vo=Ye("ckb");class NS{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),this.element=e.createElement("div"),this.element.classList.add(vo()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("label");n.classList.add(vo("l")),this.element.appendChild(n),this.labelElement=n;const s=e.createElement("input");s.classList.add(vo("i")),s.type="checkbox",this.labelElement.appendChild(s),this.inputElement=s,t.viewProps.bindDisabled(this.inputElement);const r=e.createElement("div");r.classList.add(vo("w")),this.labelElement.appendChild(r);const o=jo(e,"check");r.appendChild(o),t.value.emitter.on("change",this.onValueChange_),this.value=t.value,this.update_()}update_(){this.inputElement.checked=this.value.rawValue}onValueChange_(){this.update_()}}class US{constructor(e,t){this.onInputChange_=this.onInputChange_.bind(this),this.onLabelMouseDown_=this.onLabelMouseDown_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.view=new NS(e,{value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_),this.view.labelElement.addEventListener("mousedown",this.onLabelMouseDown_)}onInputChange_(e){const t=e.currentTarget;this.value.rawValue=t.checked,e.preventDefault(),e.stopPropagation()}onLabelMouseDown_(e){e.preventDefault()}}function FS(i){const e=[],t=Bc(i.options);return t&&e.push(t),new Lr(e)}Gt({id:"input-bool",type:"input",accept:(i,e)=>{if(typeof i!="boolean")return null;const t=Nt(e,n=>({options:n.optional.custom(qo),readonly:n.optional.constant(!1)}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>Sf,constraint:i=>FS(i.params),writer:i=>Nr},controller:i=>{const e=i.document,t=i.value,n=i.constraint,s=n&&Bo(n,Ko);return s?new Ns(e,{props:new qe({options:s.values.value("options")}),value:t,viewProps:i.viewProps}):new US(e,{value:t,viewProps:i.viewProps})},api(i){return typeof i.controller.value.rawValue!="boolean"?null:i.controller.valueController instanceof Ns?new Oc(i.controller):null}});const Ii=Ye("col");class OS{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(Ii()),t.foldable.bindExpandedClass(this.element,Ii(void 0,"expanded")),Ln(t.foldable,"completed",ks(this.element,Ii(void 0,"cpl")));const n=e.createElement("div");n.classList.add(Ii("h")),this.element.appendChild(n);const s=e.createElement("div");s.classList.add(Ii("s")),n.appendChild(s),this.swatchElement=s;const r=e.createElement("div");if(r.classList.add(Ii("t")),n.appendChild(r),this.textElement=r,t.pickerLayout==="inline"){const o=e.createElement("div");o.classList.add(Ii("p")),this.element.appendChild(o),this.pickerElement=o}else this.pickerElement=null}}function BS(i,e,t){const n=Mt(i/255,0,1),s=Mt(e/255,0,1),r=Mt(t/255,0,1),o=Math.max(n,s,r),a=Math.min(n,s,r),l=o-a;let c=0,u=0;const h=(a+o)/2;return l!==0&&(u=l/(1-Math.abs(o+a-1)),n===o?c=(s-r)/l:s===o?c=2+(r-n)/l:c=4+(n-s)/l,c=c/6+(c<0?1:0)),[c*360,u*100,h*100]}function kS(i,e,t){const n=(i%360+360)%360,s=Mt(e/100,0,1),r=Mt(t/100,0,1),o=(1-Math.abs(2*r-1))*s,a=o*(1-Math.abs(n/60%2-1)),l=r-o/2;let c,u,h;return n>=0&&n<60?[c,u,h]=[o,a,0]:n>=60&&n<120?[c,u,h]=[a,o,0]:n>=120&&n<180?[c,u,h]=[0,o,a]:n>=180&&n<240?[c,u,h]=[0,a,o]:n>=240&&n<300?[c,u,h]=[a,0,o]:[c,u,h]=[o,0,a],[(c+l)*255,(u+l)*255,(h+l)*255]}function VS(i,e,t){const n=Mt(i/255,0,1),s=Mt(e/255,0,1),r=Mt(t/255,0,1),o=Math.max(n,s,r),a=Math.min(n,s,r),l=o-a;let c;l===0?c=0:o===n?c=60*(((s-r)/l%6+6)%6):o===s?c=60*((r-n)/l+2):c=60*((n-s)/l+4);const u=o===0?0:l/o,h=o;return[c,u*100,h*100]}function Cf(i,e,t){const n=af(i,360),s=Mt(e/100,0,1),r=Mt(t/100,0,1),o=r*s,a=o*(1-Math.abs(n/60%2-1)),l=r-o;let c,u,h;return n>=0&&n<60?[c,u,h]=[o,a,0]:n>=60&&n<120?[c,u,h]=[a,o,0]:n>=120&&n<180?[c,u,h]=[0,o,a]:n>=180&&n<240?[c,u,h]=[0,a,o]:n>=240&&n<300?[c,u,h]=[a,0,o]:[c,u,h]=[o,0,a],[(c+l)*255,(u+l)*255,(h+l)*255]}function zS(i,e,t){const n=t+e*(100-Math.abs(2*t-100))/200;return[i,n!==0?e*(100-Math.abs(2*t-100))/n:0,t+e*(100-Math.abs(2*t-100))/200]}function HS(i,e,t){const n=100-Math.abs(t*(200-e)/100-100);return[i,n!==0?e*t/n:0,t*(200-e)/200]}function Dn(i){return[i[0],i[1],i[2]]}function Yo(i,e){return[i[0],i[1],i[2],e]}const GS={hsl:{hsl:(i,e,t)=>[i,e,t],hsv:zS,rgb:kS},hsv:{hsl:HS,hsv:(i,e,t)=>[i,e,t],rgb:Cf},rgb:{hsl:BS,hsv:VS,rgb:(i,e,t)=>[i,e,t]}};function Us(i,e){return[e==="float"?1:i==="rgb"?255:360,e==="float"?1:i==="rgb"?255:100,e==="float"?1:i==="rgb"?255:100]}function WS(i,e){return i===e?e:af(i,e)}function Rf(i,e,t){var n;const s=Us(e,t);return[e==="rgb"?Mt(i[0],0,s[0]):WS(i[0],s[0]),Mt(i[1],0,s[1]),Mt(i[2],0,s[2]),Mt((n=i[3])!==null&&n!==void 0?n:1,0,1)]}function Xu(i,e,t,n){const s=Us(e,t),r=Us(e,n);return i.map((o,a)=>o/s[a]*r[a])}function Pf(i,e,t){const n=Xu(i,e.mode,e.type,"int"),s=GS[e.mode][t.mode](...n);return Xu(s,t.mode,"int",t.type)}class je{static black(){return new je([0,0,0],"rgb")}constructor(e,t){this.type="int",this.mode=t,this.comps_=Rf(e,t,this.type)}getComponents(e){return Yo(Pf(Dn(this.comps_),{mode:this.mode,type:this.type},{mode:e??this.mode,type:this.type}),this.comps_[3])}toRgbaObject(){const e=this.getComponents("rgb");return{r:e[0],g:e[1],b:e[2],a:e[3]}}}const ci=Ye("colp");class XS{constructor(e,t){this.alphaViews_=null,this.element=e.createElement("div"),this.element.classList.add(ci()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(ci("hsv"));const s=e.createElement("div");s.classList.add(ci("sv")),this.svPaletteView_=t.svPaletteView,s.appendChild(this.svPaletteView_.element),n.appendChild(s);const r=e.createElement("div");r.classList.add(ci("h")),this.hPaletteView_=t.hPaletteView,r.appendChild(this.hPaletteView_.element),n.appendChild(r),this.element.appendChild(n);const o=e.createElement("div");if(o.classList.add(ci("rgb")),this.textsView_=t.textsView,o.appendChild(this.textsView_.element),this.element.appendChild(o),t.alphaViews){this.alphaViews_={palette:t.alphaViews.palette,text:t.alphaViews.text};const a=e.createElement("div");a.classList.add(ci("a"));const l=e.createElement("div");l.classList.add(ci("ap")),l.appendChild(this.alphaViews_.palette.element),a.appendChild(l);const c=e.createElement("div");c.classList.add(ci("at")),c.appendChild(this.alphaViews_.text.element),a.appendChild(c),this.element.appendChild(a)}}get allFocusableElements(){const e=[this.svPaletteView_.element,this.hPaletteView_.element,this.textsView_.modeSelectElement,...this.textsView_.inputViews.map(t=>t.inputElement)];return this.alphaViews_&&e.push(this.alphaViews_.palette.element,this.alphaViews_.text.inputElement),e}}function jS(i){return i==="int"?"int":i==="float"?"float":void 0}function Vc(i){return Nt(i,e=>({color:e.optional.object({alpha:e.optional.boolean,type:e.optional.custom(jS)}),expanded:e.optional.boolean,picker:e.optional.custom(Af),readonly:e.optional.constant(!1)}))}function Bi(i){return i?.1:1}function If(i){var e;return(e=i.color)===null||e===void 0?void 0:e.type}class zc{constructor(e,t){this.type="float",this.mode=t,this.comps_=Rf(e,t,this.type)}getComponents(e){return Yo(Pf(Dn(this.comps_),{mode:this.mode,type:this.type},{mode:e??this.mode,type:this.type}),this.comps_[3])}toRgbaObject(){const e=this.getComponents("rgb");return{r:e[0],g:e[1],b:e[2],a:e[3]}}}const KS={int:(i,e)=>new je(i,e),float:(i,e)=>new zc(i,e)};function Hc(i,e,t){return KS[t](i,e)}function qS(i){return i.type==="float"}function YS(i){return i.type==="int"}function $S(i){const e=i.getComponents(),t=Us(i.mode,"int");return new je([Math.round(Qe(e[0],0,1,0,t[0])),Math.round(Qe(e[1],0,1,0,t[1])),Math.round(Qe(e[2],0,1,0,t[2])),e[3]],i.mode)}function ZS(i){const e=i.getComponents(),t=Us(i.mode,"int");return new zc([Qe(e[0],0,t[0],0,1),Qe(e[1],0,t[1],0,1),Qe(e[2],0,t[2],0,1),e[3]],i.mode)}function zt(i,e){if(i.type===e)return i;if(YS(i)&&e==="float")return ZS(i);if(qS(i)&&e==="int")return $S(i);throw rn.shouldNeverHappen()}function JS(i,e){return i.alpha===e.alpha&&i.mode===e.mode&&i.notation===e.notation&&i.type===e.type}function mn(i,e){const t=i.match(/^(.+)%$/);return Math.min(t?parseFloat(t[1])*.01*e:parseFloat(i),e)}const QS={deg:i=>i,grad:i=>i*360/400,rad:i=>i*360/(2*Math.PI),turn:i=>i*360};function Lf(i){const e=i.match(/^([0-9.]+?)(deg|grad|rad|turn)$/);if(!e)return parseFloat(i);const t=parseFloat(e[1]),n=e[2];return QS[n](t)}function Df(i){const e=i.match(/^rgb\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!e)return null;const t=[mn(e[1],255),mn(e[2],255),mn(e[3],255)];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])?null:t}function eE(i){const e=Df(i);return e?new je(e,"rgb"):null}function Nf(i){const e=i.match(/^rgba\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!e)return null;const t=[mn(e[1],255),mn(e[2],255),mn(e[3],255),mn(e[4],1)];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])||isNaN(t[3])?null:t}function tE(i){const e=Nf(i);return e?new je(e,"rgb"):null}function Uf(i){const e=i.match(/^hsl\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!e)return null;const t=[Lf(e[1]),mn(e[2],100),mn(e[3],100)];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])?null:t}function nE(i){const e=Uf(i);return e?new je(e,"hsl"):null}function Ff(i){const e=i.match(/^hsla\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!e)return null;const t=[Lf(e[1]),mn(e[2],100),mn(e[3],100),mn(e[4],1)];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])||isNaN(t[3])?null:t}function iE(i){const e=Ff(i);return e?new je(e,"hsl"):null}function Of(i){const e=i.match(/^#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(e)return[parseInt(e[1]+e[1],16),parseInt(e[2]+e[2],16),parseInt(e[3]+e[3],16)];const t=i.match(/^(?:#|0x)([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:null}function sE(i){const e=Of(i);return e?new je(e,"rgb"):null}function Bf(i){const e=i.match(/^#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(e)return[parseInt(e[1]+e[1],16),parseInt(e[2]+e[2],16),parseInt(e[3]+e[3],16),Qe(parseInt(e[4]+e[4],16),0,255,0,1)];const t=i.match(/^(?:#|0x)?([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16),Qe(parseInt(t[4],16),0,255,0,1)]:null}function rE(i){const e=Bf(i);return e?new je(e,"rgb"):null}function kf(i){const e=i.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!e)return null;const t=[parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])?null:t}function oE(i){return e=>{const t=kf(e);return t?Hc(t,"rgb",i):null}}function Vf(i){const e=i.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*a\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!e)return null;const t=[parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]),parseFloat(e[4])];return isNaN(t[0])||isNaN(t[1])||isNaN(t[2])||isNaN(t[3])?null:t}function aE(i){return e=>{const t=Vf(e);return t?Hc(t,"rgb",i):null}}const lE=[{parser:Of,result:{alpha:!1,mode:"rgb",notation:"hex"}},{parser:Bf,result:{alpha:!0,mode:"rgb",notation:"hex"}},{parser:Df,result:{alpha:!1,mode:"rgb",notation:"func"}},{parser:Nf,result:{alpha:!0,mode:"rgb",notation:"func"}},{parser:Uf,result:{alpha:!1,mode:"hsl",notation:"func"}},{parser:Ff,result:{alpha:!0,mode:"hsl",notation:"func"}},{parser:kf,result:{alpha:!1,mode:"rgb",notation:"object"}},{parser:Vf,result:{alpha:!0,mode:"rgb",notation:"object"}}];function cE(i){return lE.reduce((e,{parser:t,result:n})=>e||(t(i)?n:null),null)}function hE(i,e="int"){const t=cE(i);return t?t.notation==="hex"&&e!=="float"?Object.assign(Object.assign({},t),{type:"int"}):t.notation==="func"?Object.assign(Object.assign({},t),{type:e}):null:null}function Ur(i){const e=[sE,rE,eE,tE,nE,iE];e.push(oE("int"),aE("int"));const t=wS(e);return n=>{const s=t(n);return s?zt(s,i):null}}function uE(i){const e=Ur("int");if(typeof i!="string")return je.black();const t=e(i);return t??je.black()}function zf(i){const e=Mt(Math.floor(i),0,255).toString(16);return e.length===1?`0${e}`:e}function Gc(i,e="#"){const t=Dn(i.getComponents("rgb")).map(zf).join("");return`${e}${t}`}function Wc(i,e="#"){const t=i.getComponents("rgb"),n=[t[0],t[1],t[2],t[3]*255].map(zf).join("");return`${e}${n}`}function Hf(i){const e=Zt(0),t=zt(i,"int");return`rgb(${Dn(t.getComponents("rgb")).map(s=>e(s)).join(", ")})`}function To(i){const e=Zt(2),t=Zt(0);return`rgba(${zt(i,"int").getComponents("rgb").map((r,o)=>(o===3?e:t)(r)).join(", ")})`}function dE(i){const e=[Zt(0),ko,ko],t=zt(i,"int");return`hsl(${Dn(t.getComponents("hsl")).map((s,r)=>e[r](s)).join(", ")})`}function fE(i){const e=[Zt(0),ko,ko,Zt(2)];return`hsla(${zt(i,"int").getComponents("hsl").map((s,r)=>e[r](s)).join(", ")})`}function Gf(i,e){const t=Zt(e==="float"?2:0),n=["r","g","b"],s=zt(i,e);return`{${Dn(s.getComponents("rgb")).map((o,a)=>`${n[a]}: ${t(o)}`).join(", ")}}`}function pE(i){return e=>Gf(e,i)}function Wf(i,e){const t=Zt(2),n=Zt(e==="float"?2:0),s=["r","g","b","a"];return`{${zt(i,e).getComponents("rgb").map((a,l)=>{const c=l===3?t:n;return`${s[l]}: ${c(a)}`}).join(", ")}}`}function mE(i){return e=>Wf(e,i)}const gE=[{format:{alpha:!1,mode:"rgb",notation:"hex",type:"int"},stringifier:Gc},{format:{alpha:!0,mode:"rgb",notation:"hex",type:"int"},stringifier:Wc},{format:{alpha:!1,mode:"rgb",notation:"func",type:"int"},stringifier:Hf},{format:{alpha:!0,mode:"rgb",notation:"func",type:"int"},stringifier:To},{format:{alpha:!1,mode:"hsl",notation:"func",type:"int"},stringifier:dE},{format:{alpha:!0,mode:"hsl",notation:"func",type:"int"},stringifier:fE},...["int","float"].reduce((i,e)=>[...i,{format:{alpha:!1,mode:"rgb",notation:"object",type:e},stringifier:pE(e)},{format:{alpha:!0,mode:"rgb",notation:"object",type:e},stringifier:mE(e)}],[])];function Xf(i){return gE.reduce((e,t)=>e||(JS(t.format,i)?t.stringifier:null),null)}const or=Ye("apl");class _E{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),this.value=t.value,this.value.emitter.on("change",this.onValueChange_),this.element=e.createElement("div"),this.element.classList.add(or()),t.viewProps.bindClassModifiers(this.element),t.viewProps.bindTabIndex(this.element);const n=e.createElement("div");n.classList.add(or("b")),this.element.appendChild(n);const s=e.createElement("div");s.classList.add(or("c")),n.appendChild(s),this.colorElem_=s;const r=e.createElement("div");r.classList.add(or("m")),this.element.appendChild(r),this.markerElem_=r;const o=e.createElement("div");o.classList.add(or("p")),this.markerElem_.appendChild(o),this.previewElem_=o,this.update_()}update_(){const e=this.value.rawValue,t=e.getComponents("rgb"),n=new je([t[0],t[1],t[2],0],"rgb"),s=new je([t[0],t[1],t[2],255],"rgb"),r=["to right",To(n),To(s)];this.colorElem_.style.background=`linear-gradient(${r.join(",")})`,this.previewElem_.style.backgroundColor=To(e);const o=Qe(t[3],0,1,0,100);this.markerElem_.style.left=`${o}%`}onValueChange_(){this.update_()}}class vE{constructor(e,t){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.view=new _E(e,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Vi(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(e,t){if(!e.point)return;const n=e.point.x/e.bounds.width,s=this.value.rawValue,[r,o,a]=s.getComponents("hsv");this.value.setRawValue(new je([r,o,a,n],"hsv"),t)}onPointerDown_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerMove_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerUp_(e){this.handlePointerEvent_(e.data,{forceEmit:!0,last:!0})}onKeyDown_(e){const t=Kt(Bi(!0),ei(e));if(t===0)return;const n=this.value.rawValue,[s,r,o,a]=n.getComponents("hsv");this.value.setRawValue(new je([s,r,o,a+t],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(e){Kt(Bi(!0),ei(e))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const ls=Ye("coltxt");function xE(i){const e=i.createElement("select"),t=[{text:"RGB",value:"rgb"},{text:"HSL",value:"hsl"},{text:"HSV",value:"hsv"},{text:"HEX",value:"hex"}];return e.appendChild(t.reduce((n,s)=>{const r=i.createElement("option");return r.textContent=s.text,r.value=s.value,n.appendChild(r),n},i.createDocumentFragment())),e}class bE{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(ls()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(ls("m")),this.modeElem_=xE(e),this.modeElem_.classList.add(ls("ms")),n.appendChild(this.modeSelectElement),t.viewProps.bindDisabled(this.modeElem_);const s=e.createElement("div");s.classList.add(ls("mm")),s.appendChild(jo(e,"dropdown")),n.appendChild(s),this.element.appendChild(n);const r=e.createElement("div");r.classList.add(ls("w")),this.element.appendChild(r),this.inputsElem_=r,this.inputViews_=t.inputViews,this.applyInputViews_(),Jn(t.mode,o=>{this.modeElem_.value=o})}get modeSelectElement(){return this.modeElem_}get inputViews(){return this.inputViews_}set inputViews(e){this.inputViews_=e,this.applyInputViews_()}applyInputViews_(){mf(this.inputsElem_);const e=this.element.ownerDocument;this.inputViews_.forEach(t=>{const n=e.createElement("div");n.classList.add(ls("c")),n.appendChild(t.element),this.inputsElem_.appendChild(n)})}}function yE(i){return Zt(i==="float"?2:0)}function ME(i,e,t){const n=Us(i,e)[t];return new Wo({min:0,max:n})}function SE(i,e,t){return new Dr(i,{arrayPosition:t===0?"fst":t===2?"lst":"mid",parser:e.parser,props:qe.fromObject({formatter:yE(e.colorType),keyScale:Bi(!1),pointerScale:e.colorType==="float"?.01:1}),value:Pt(0,{constraint:ME(e.colorMode,e.colorType,t)}),viewProps:e.viewProps})}function EE(i,e){const t={colorMode:e.colorMode,colorType:e.colorType,parser:bi,viewProps:e.viewProps};return[0,1,2].map(n=>{const s=SE(i,t,n);return Vs({primary:e.value,secondary:s.value,forward(r){return zt(r,e.colorType).getComponents(e.colorMode)[n]},backward(r,o){const a=e.colorMode,c=zt(r,e.colorType).getComponents(a);c[n]=o;const u=Hc(Yo(Dn(c),c[3]),a,e.colorType);return zt(u,"int")}}),s})}function wE(i,e){const t=new kc(i,{parser:Ur("int"),props:qe.fromObject({formatter:Gc}),value:Pt(je.black()),viewProps:e.viewProps});return Vs({primary:e.value,secondary:t.value,forward:n=>new je(Dn(n.getComponents()),n.mode),backward:(n,s)=>new je(Yo(Dn(s.getComponents(n.mode)),n.getComponents()[3]),n.mode)}),[t]}function TE(i){return i!=="hex"}class AE{constructor(e,t){this.onModeSelectChange_=this.onModeSelectChange_.bind(this),this.colorType_=t.colorType,this.value=t.value,this.viewProps=t.viewProps,this.colorMode=Pt(this.value.rawValue.mode),this.ccs_=this.createComponentControllers_(e),this.view=new bE(e,{mode:this.colorMode,inputViews:[this.ccs_[0].view,this.ccs_[1].view,this.ccs_[2].view],viewProps:this.viewProps}),this.view.modeSelectElement.addEventListener("change",this.onModeSelectChange_)}createComponentControllers_(e){const t=this.colorMode.rawValue;return TE(t)?EE(e,{colorMode:t,colorType:this.colorType_,value:this.value,viewProps:this.viewProps}):wE(e,{value:this.value,viewProps:this.viewProps})}onModeSelectChange_(e){const t=e.currentTarget;this.colorMode.rawValue=t.value,this.ccs_=this.createComponentControllers_(this.view.element.ownerDocument),this.view.inputViews=this.ccs_.map(n=>n.view)}}const Ka=Ye("hpl");class CE{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),this.value=t.value,this.value.emitter.on("change",this.onValueChange_),this.element=e.createElement("div"),this.element.classList.add(Ka()),t.viewProps.bindClassModifiers(this.element),t.viewProps.bindTabIndex(this.element);const n=e.createElement("div");n.classList.add(Ka("c")),this.element.appendChild(n);const s=e.createElement("div");s.classList.add(Ka("m")),this.element.appendChild(s),this.markerElem_=s,this.update_()}update_(){const e=this.value.rawValue,[t]=e.getComponents("hsv");this.markerElem_.style.backgroundColor=Hf(new je([t,100,100],"hsv"));const n=Qe(t,0,360,0,100);this.markerElem_.style.left=`${n}%`}onValueChange_(){this.update_()}}class RE{constructor(e,t){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.view=new CE(e,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Vi(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(e,t){if(!e.point)return;const n=Qe(Mt(e.point.x,0,e.bounds.width),0,e.bounds.width,0,360),s=this.value.rawValue,[,r,o,a]=s.getComponents("hsv");this.value.setRawValue(new je([n,r,o,a],"hsv"),t)}onPointerDown_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerMove_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerUp_(e){this.handlePointerEvent_(e.data,{forceEmit:!0,last:!0})}onKeyDown_(e){const t=Kt(Bi(!1),ei(e));if(t===0)return;const n=this.value.rawValue,[s,r,o,a]=n.getComponents("hsv");this.value.setRawValue(new je([s+t,r,o,a],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(e){Kt(Bi(!1),ei(e))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const qa=Ye("svp"),ju=64;class PE{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),this.value=t.value,this.value.emitter.on("change",this.onValueChange_),this.element=e.createElement("div"),this.element.classList.add(qa()),t.viewProps.bindClassModifiers(this.element),t.viewProps.bindTabIndex(this.element);const n=e.createElement("canvas");n.height=ju,n.width=ju,n.classList.add(qa("c")),this.element.appendChild(n),this.canvasElement=n;const s=e.createElement("div");s.classList.add(qa("m")),this.element.appendChild(s),this.markerElem_=s,this.update_()}update_(){const e=zM(this.canvasElement);if(!e)return;const n=this.value.rawValue.getComponents("hsv"),s=this.canvasElement.width,r=this.canvasElement.height,o=e.getImageData(0,0,s,r),a=o.data;for(let u=0;u<r;u++)for(let h=0;h<s;h++){const d=Qe(h,0,s,0,100),p=Qe(u,0,r,100,0),g=Cf(n[0],d,p),_=(u*s+h)*4;a[_]=g[0],a[_+1]=g[1],a[_+2]=g[2],a[_+3]=255}e.putImageData(o,0,0);const l=Qe(n[1],0,100,0,100);this.markerElem_.style.left=`${l}%`;const c=Qe(n[2],0,100,100,0);this.markerElem_.style.top=`${c}%`}onValueChange_(){this.update_()}}class IE{constructor(e,t){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.view=new PE(e,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Vi(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(e,t){if(!e.point)return;const n=Qe(e.point.x,0,e.bounds.width,0,100),s=Qe(e.point.y,0,e.bounds.height,100,0),[r,,,o]=this.value.rawValue.getComponents("hsv");this.value.setRawValue(new je([r,n,s,o],"hsv"),t)}onPointerDown_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerMove_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerUp_(e){this.handlePointerEvent_(e.data,{forceEmit:!0,last:!0})}onKeyDown_(e){wf(e.key)&&e.preventDefault();const[t,n,s,r]=this.value.rawValue.getComponents("hsv"),o=Bi(!1),a=Kt(o,ei(e)),l=Kt(o,Er(e));a===0&&l===0||this.value.setRawValue(new je([t,n+a,s+l,r],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(e){const t=Bi(!1),n=Kt(t,ei(e)),s=Kt(t,Er(e));n===0&&s===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class LE{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.hPaletteC_=new RE(e,{value:this.value,viewProps:this.viewProps}),this.svPaletteC_=new IE(e,{value:this.value,viewProps:this.viewProps}),this.alphaIcs_=t.supportsAlpha?{palette:new vE(e,{value:this.value,viewProps:this.viewProps}),text:new Dr(e,{parser:bi,props:qe.fromObject({pointerScale:.01,keyScale:.1,formatter:Zt(2)}),value:Pt(0,{constraint:new Wo({min:0,max:1})}),viewProps:this.viewProps})}:null,this.alphaIcs_&&Vs({primary:this.value,secondary:this.alphaIcs_.text.value,forward:n=>n.getComponents()[3],backward:(n,s)=>{const r=n.getComponents();return r[3]=s,new je(r,n.mode)}}),this.textsC_=new AE(e,{colorType:t.colorType,value:this.value,viewProps:this.viewProps}),this.view=new XS(e,{alphaViews:this.alphaIcs_?{palette:this.alphaIcs_.palette.view,text:this.alphaIcs_.text.view}:null,hPaletteView:this.hPaletteC_.view,supportsAlpha:t.supportsAlpha,svPaletteView:this.svPaletteC_.view,textsView:this.textsC_.view,viewProps:this.viewProps})}get textsController(){return this.textsC_}}const Ya=Ye("colsw");class DE{constructor(e,t){this.onValueChange_=this.onValueChange_.bind(this),t.value.emitter.on("change",this.onValueChange_),this.value=t.value,this.element=e.createElement("div"),this.element.classList.add(Ya()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(Ya("sw")),this.element.appendChild(n),this.swatchElem_=n;const s=e.createElement("button");s.classList.add(Ya("b")),t.viewProps.bindDisabled(s),this.element.appendChild(s),this.buttonElement=s,this.update_()}update_(){const e=this.value.rawValue;this.swatchElem_.style.backgroundColor=Wc(e)}onValueChange_(){this.update_()}}class NE{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.view=new DE(e,{value:this.value,viewProps:this.viewProps})}}class Xc{constructor(e,t){this.onButtonBlur_=this.onButtonBlur_.bind(this),this.onButtonClick_=this.onButtonClick_.bind(this),this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.foldable_=Pr.create(t.expanded),this.swatchC_=new NE(e,{value:this.value,viewProps:this.viewProps});const n=this.swatchC_.view.buttonElement;n.addEventListener("blur",this.onButtonBlur_),n.addEventListener("click",this.onButtonClick_),this.textC_=new kc(e,{parser:t.parser,props:qe.fromObject({formatter:t.formatter}),value:this.value,viewProps:this.viewProps}),this.view=new OS(e,{foldable:this.foldable_,pickerLayout:t.pickerLayout}),this.view.swatchElement.appendChild(this.swatchC_.view.element),this.view.textElement.appendChild(this.textC_.view.element),this.popC_=t.pickerLayout==="popup"?new Mf(e,{viewProps:this.viewProps}):null;const s=new LE(e,{colorType:t.colorType,supportsAlpha:t.supportsAlpha,value:this.value,viewProps:this.viewProps});s.view.allFocusableElements.forEach(r=>{r.addEventListener("blur",this.onPopupChildBlur_),r.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=s,this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(s.view.element),Vs({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:r=>r,backward:(r,o)=>o})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),Fc(this.foldable_,this.view.pickerElement))}get textController(){return this.textC_}onButtonBlur_(e){if(!this.popC_)return;const t=this.view.element,n=e.relatedTarget;(!n||!t.contains(n))&&(this.popC_.shows.rawValue=!1)}onButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(e){if(!this.popC_)return;const t=this.popC_.view.element,n=gf(e);n&&t.contains(n)||n&&n===this.swatchC_.view.buttonElement&&!Pc(t.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(e){this.popC_?e.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&e.key==="Escape"&&this.swatchC_.view.buttonElement.focus()}}function UE(i){return Dn(i.getComponents("rgb")).reduce((e,t)=>e<<8|Math.floor(t)&255,0)}function FE(i){return i.getComponents("rgb").reduce((e,t,n)=>{const s=Math.floor(n===3?t*255:t)&255;return e<<8|s},0)>>>0}function OE(i){return new je([i>>16&255,i>>8&255,i&255],"rgb")}function BE(i){return new je([i>>24&255,i>>16&255,i>>8&255,Qe(i&255,0,255,0,1)],"rgb")}function kE(i){return typeof i!="number"?je.black():OE(i)}function VE(i){return typeof i!="number"?je.black():BE(i)}function Ao(i,e){return typeof i!="object"||mt(i)?!1:e in i&&typeof i[e]=="number"}function jf(i){return Ao(i,"r")&&Ao(i,"g")&&Ao(i,"b")}function Kf(i){return jf(i)&&Ao(i,"a")}function qf(i){return jf(i)}function jc(i,e){if(i.mode!==e.mode||i.type!==e.type)return!1;const t=i.getComponents(),n=e.getComponents();for(let s=0;s<t.length;s++)if(t[s]!==n[s])return!1;return!0}function Ku(i){return"a"in i?[i.r,i.g,i.b,i.a]:[i.r,i.g,i.b]}function zE(i){const e=Xf(i);return e?(t,n)=>{Nr(t,e(n))}:null}function HE(i){const e=i?FE:UE;return(t,n)=>{Nr(t,e(n))}}function GE(i,e,t){const s=zt(e,t).toRgbaObject();i.writeProperty("r",s.r),i.writeProperty("g",s.g),i.writeProperty("b",s.b),i.writeProperty("a",s.a)}function WE(i,e,t){const s=zt(e,t).toRgbaObject();i.writeProperty("r",s.r),i.writeProperty("g",s.g),i.writeProperty("b",s.b)}function XE(i,e){return(t,n)=>{i?GE(t,n,e):WE(t,n,e)}}function jE(i){var e;return!!(!((e=i?.color)===null||e===void 0)&&e.alpha)}function KE(i){return i?e=>Wc(e,"0x"):e=>Gc(e,"0x")}function qE(i){return"color"in i||i.view==="color"}Gt({id:"input-color-number",type:"input",accept:(i,e)=>{if(typeof i!="number"||!qE(e))return null;const t=Vc(e);return t?{initialValue:i,params:Object.assign(Object.assign({},t),{supportsAlpha:jE(e)})}:null},binding:{reader:i=>i.params.supportsAlpha?VE:kE,equals:jc,writer:i=>HE(i.params.supportsAlpha)},controller:i=>{var e,t;return new Xc(i.document,{colorType:"int",expanded:(e=i.params.expanded)!==null&&e!==void 0?e:!1,formatter:KE(i.params.supportsAlpha),parser:Ur("int"),pickerLayout:(t=i.params.picker)!==null&&t!==void 0?t:"popup",supportsAlpha:i.params.supportsAlpha,value:i.value,viewProps:i.viewProps})}});function YE(i,e){if(!qf(i))return zt(je.black(),e);if(e==="int"){const t=Ku(i);return new je(t,"rgb")}if(e==="float"){const t=Ku(i);return new zc(t,"rgb")}return zt(je.black(),"int")}function $E(i){return Kf(i)}function ZE(i){return e=>{const t=YE(e,i);return zt(t,"int")}}function JE(i,e){return t=>i?Wf(t,e):Gf(t,e)}Gt({id:"input-color-object",type:"input",accept:(i,e)=>{var t;if(!qf(i))return null;const n=Vc(e);return n?{initialValue:i,params:Object.assign(Object.assign({},n),{colorType:(t=If(e))!==null&&t!==void 0?t:"int"})}:null},binding:{reader:i=>ZE(i.params.colorType),equals:jc,writer:i=>XE($E(i.initialValue),i.params.colorType)},controller:i=>{var e,t;const n=Kf(i.initialValue);return new Xc(i.document,{colorType:i.params.colorType,expanded:(e=i.params.expanded)!==null&&e!==void 0?e:!1,formatter:JE(n,i.params.colorType),parser:Ur("int"),pickerLayout:(t=i.params.picker)!==null&&t!==void 0?t:"popup",supportsAlpha:n,value:i.value,viewProps:i.viewProps})}});Gt({id:"input-color-string",type:"input",accept:(i,e)=>{if(typeof i!="string"||e.view==="text")return null;const t=hE(i,If(e));if(!t)return null;const n=Xf(t);if(!n)return null;const s=Vc(e);return s?{initialValue:i,params:Object.assign(Object.assign({},s),{format:t,stringifier:n})}:null},binding:{reader:()=>uE,equals:jc,writer:i=>{const e=zE(i.params.format);if(!e)throw rn.notBindable();return e}},controller:i=>{var e,t;return new Xc(i.document,{colorType:i.params.format.type,expanded:(e=i.params.expanded)!==null&&e!==void 0?e:!1,formatter:i.params.stringifier,parser:Ur("int"),pickerLayout:(t=i.params.picker)!==null&&t!==void 0?t:"popup",supportsAlpha:i.params.format.alpha,value:i.value,viewProps:i.viewProps})}});class Kc{constructor(e){this.components=e.components,this.asm_=e.assembly}constrain(e){const t=this.asm_.toComponents(e).map((n,s)=>{var r,o;return(o=(r=this.components[s])===null||r===void 0?void 0:r.constrain(n))!==null&&o!==void 0?o:n});return this.asm_.fromComponents(t)}}const qu=Ye("pndtxt");class QE{constructor(e,t){this.textViews=t.textViews,this.element=e.createElement("div"),this.element.classList.add(qu()),this.textViews.forEach(n=>{const s=e.createElement("div");s.classList.add(qu("a")),s.appendChild(n.element),this.element.appendChild(s)})}}function ew(i,e,t){return new Dr(i,{arrayPosition:t===0?"fst":t===e.axes.length-1?"lst":"mid",parser:e.parser,props:e.axes[t].textProps,value:Pt(0,{constraint:e.axes[t].constraint}),viewProps:e.viewProps})}class qc{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.acs_=t.axes.map((n,s)=>ew(e,t,s)),this.acs_.forEach((n,s)=>{Vs({primary:this.value,secondary:n.value,forward:r=>t.assembly.toComponents(r)[s],backward:(r,o)=>{const a=t.assembly.toComponents(r);return a[s]=o,t.assembly.fromComponents(a)}})}),this.view=new QE(e,{textViews:this.acs_.map(n=>n.view)})}get textControllers(){return this.acs_}}class tw extends Rc{get max(){return this.controller.valueController.sliderController.props.get("max")}set max(e){this.controller.valueController.sliderController.props.set("max",e)}get min(){return this.controller.valueController.sliderController.props.get("min")}set min(e){this.controller.valueController.sliderController.props.set("min",e)}}function nw(i,e){const t=[],n=cf(i,e);n&&t.push(n);const s=hf(i);s&&t.push(s);const r=Bc(i.options);return r&&t.push(r),new Lr(t)}Gt({id:"input-number",type:"input",accept:(i,e)=>{if(typeof i!="number")return null;const t=Nt(e,n=>Object.assign(Object.assign({},df(n)),{options:n.optional.custom(qo),readonly:n.optional.constant(!1)}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>of,constraint:i=>nw(i.params,i.initialValue),writer:i=>Nr},controller:i=>{const e=i.value,t=i.constraint,n=t&&Bo(t,Ko);if(n)return new Ns(i.document,{props:new qe({options:n.values.value("options")}),value:e,viewProps:i.viewProps});const s=uf(i.params,e.rawValue),r=t&&Bo(t,Wo);return r?new Wu(i.document,Object.assign(Object.assign({},LS(Object.assign(Object.assign({},s),{keyScale:Pt(s.keyScale),max:r.values.value("max"),min:r.values.value("min")}))),{parser:bi,value:e,viewProps:i.viewProps})):new Dr(i.document,{parser:bi,props:qe.fromObject(s),value:e,viewProps:i.viewProps})},api(i){return typeof i.controller.value.rawValue!="number"?null:i.controller.valueController instanceof Wu?new tw(i.controller):i.controller.valueController instanceof Ns?new Oc(i.controller):null}});class xi{constructor(e=0,t=0){this.x=e,this.y=t}getComponents(){return[this.x,this.y]}static isObject(e){if(mt(e))return!1;const t=e.x,n=e.y;return!(typeof t!="number"||typeof n!="number")}static equals(e,t){return e.x===t.x&&e.y===t.y}toObject(){return{x:this.x,y:this.y}}}const Yf={toComponents:i=>i.getComponents(),fromComponents:i=>new xi(...i)},cs=Ye("p2d");class iw{constructor(e,t){this.element=e.createElement("div"),this.element.classList.add(cs()),t.viewProps.bindClassModifiers(this.element),Jn(t.expanded,ks(this.element,cs(void 0,"expanded")));const n=e.createElement("div");n.classList.add(cs("h")),this.element.appendChild(n);const s=e.createElement("button");s.classList.add(cs("b")),s.appendChild(jo(e,"p2dpad")),t.viewProps.bindDisabled(s),n.appendChild(s),this.buttonElement=s;const r=e.createElement("div");if(r.classList.add(cs("t")),n.appendChild(r),this.textElement=r,t.pickerLayout==="inline"){const o=e.createElement("div");o.classList.add(cs("p")),this.element.appendChild(o),this.pickerElement=o}else this.pickerElement=null}}const hi=Ye("p2dp");class sw{constructor(e,t){this.onFoldableChange_=this.onFoldableChange_.bind(this),this.onPropsChange_=this.onPropsChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.props_=t.props,this.props_.emitter.on("change",this.onPropsChange_),this.element=e.createElement("div"),this.element.classList.add(hi()),t.layout==="popup"&&this.element.classList.add(hi(void 0,"p")),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("div");n.classList.add(hi("p")),t.viewProps.bindTabIndex(n),this.element.appendChild(n),this.padElement=n;const s=e.createElementNS(Pn,"svg");s.classList.add(hi("g")),this.padElement.appendChild(s),this.svgElem_=s;const r=e.createElementNS(Pn,"line");r.classList.add(hi("ax")),r.setAttributeNS(null,"x1","0"),r.setAttributeNS(null,"y1","50%"),r.setAttributeNS(null,"x2","100%"),r.setAttributeNS(null,"y2","50%"),this.svgElem_.appendChild(r);const o=e.createElementNS(Pn,"line");o.classList.add(hi("ax")),o.setAttributeNS(null,"x1","50%"),o.setAttributeNS(null,"y1","0"),o.setAttributeNS(null,"x2","50%"),o.setAttributeNS(null,"y2","100%"),this.svgElem_.appendChild(o);const a=e.createElementNS(Pn,"line");a.classList.add(hi("l")),a.setAttributeNS(null,"x1","50%"),a.setAttributeNS(null,"y1","50%"),this.svgElem_.appendChild(a),this.lineElem_=a;const l=e.createElement("div");l.classList.add(hi("m")),this.padElement.appendChild(l),this.markerElem_=l,t.value.emitter.on("change",this.onValueChange_),this.value=t.value,this.update_()}get allFocusableElements(){return[this.padElement]}update_(){const[e,t]=this.value.rawValue.getComponents(),n=this.props_.get("max"),s=Qe(e,-n,+n,0,100),r=Qe(t,-n,+n,0,100),o=this.props_.get("invertsY")?100-r:r;this.lineElem_.setAttributeNS(null,"x2",`${s}%`),this.lineElem_.setAttributeNS(null,"y2",`${o}%`),this.markerElem_.style.left=`${s}%`,this.markerElem_.style.top=`${o}%`}onValueChange_(){this.update_()}onPropsChange_(){this.update_()}onFoldableChange_(){this.update_()}}function Yu(i,e,t){return[Kt(e[0],ei(i)),Kt(e[1],Er(i))*(t?1:-1)]}class rw{constructor(e,t){this.onPadKeyDown_=this.onPadKeyDown_.bind(this),this.onPadKeyUp_=this.onPadKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.props=t.props,this.value=t.value,this.viewProps=t.viewProps,this.view=new sw(e,{layout:t.layout,props:this.props,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Vi(this.view.padElement),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.padElement.addEventListener("keydown",this.onPadKeyDown_),this.view.padElement.addEventListener("keyup",this.onPadKeyUp_)}handlePointerEvent_(e,t){if(!e.point)return;const n=this.props.get("max"),s=Qe(e.point.x,0,e.bounds.width,-n,+n),r=Qe(this.props.get("invertsY")?e.bounds.height-e.point.y:e.point.y,0,e.bounds.height,-n,+n);this.value.setRawValue(new xi(s,r),t)}onPointerDown_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerMove_(e){this.handlePointerEvent_(e.data,{forceEmit:!1,last:!1})}onPointerUp_(e){this.handlePointerEvent_(e.data,{forceEmit:!0,last:!0})}onPadKeyDown_(e){wf(e.key)&&e.preventDefault();const[t,n]=Yu(e,[this.props.get("xKeyScale"),this.props.get("yKeyScale")],this.props.get("invertsY"));t===0&&n===0||this.value.setRawValue(new xi(this.value.rawValue.x+t,this.value.rawValue.y+n),{forceEmit:!1,last:!1})}onPadKeyUp_(e){const[t,n]=Yu(e,[this.props.get("xKeyScale"),this.props.get("yKeyScale")],this.props.get("invertsY"));t===0&&n===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class ow{constructor(e,t){var n,s;this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.onPadButtonBlur_=this.onPadButtonBlur_.bind(this),this.onPadButtonClick_=this.onPadButtonClick_.bind(this),this.value=t.value,this.viewProps=t.viewProps,this.foldable_=Pr.create(t.expanded),this.popC_=t.pickerLayout==="popup"?new Mf(e,{viewProps:this.viewProps}):null;const r=new rw(e,{layout:t.pickerLayout,props:new qe({invertsY:Pt(t.invertsY),max:Pt(t.max),xKeyScale:t.axes[0].textProps.value("keyScale"),yKeyScale:t.axes[1].textProps.value("keyScale")}),value:this.value,viewProps:this.viewProps});r.view.allFocusableElements.forEach(o=>{o.addEventListener("blur",this.onPopupChildBlur_),o.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=r,this.textC_=new qc(e,{assembly:Yf,axes:t.axes,parser:t.parser,value:this.value,viewProps:this.viewProps}),this.view=new iw(e,{expanded:this.foldable_.value("expanded"),pickerLayout:t.pickerLayout,viewProps:this.viewProps}),this.view.textElement.appendChild(this.textC_.view.element),(n=this.view.buttonElement)===null||n===void 0||n.addEventListener("blur",this.onPadButtonBlur_),(s=this.view.buttonElement)===null||s===void 0||s.addEventListener("click",this.onPadButtonClick_),this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(this.pickerC_.view.element),Vs({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:o=>o,backward:(o,a)=>a})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),Fc(this.foldable_,this.view.pickerElement))}get textController(){return this.textC_}onPadButtonBlur_(e){if(!this.popC_)return;const t=this.view.element,n=e.relatedTarget;(!n||!t.contains(n))&&(this.popC_.shows.rawValue=!1)}onPadButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(e){if(!this.popC_)return;const t=this.popC_.view.element,n=gf(e);n&&t.contains(n)||n&&n===this.view.buttonElement&&!Pc(t.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(e){this.popC_?e.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&e.key==="Escape"&&this.view.buttonElement.focus()}}function aw(i){return xi.isObject(i)?new xi(i.x,i.y):new xi}function lw(i,e){i.writeProperty("x",e.x),i.writeProperty("y",e.y)}function cw(i,e){return new Kc({assembly:Yf,components:[$n(Object.assign(Object.assign({},i),i.x),e.x),$n(Object.assign(Object.assign({},i),i.y),e.y)]})}function $u(i,e){var t,n;if(!mt(i.min)||!mt(i.max))return Math.max(Math.abs((t=i.min)!==null&&t!==void 0?t:0),Math.abs((n=i.max)!==null&&n!==void 0?n:0));const s=lf(i);return Math.max(Math.abs(s)*10,Math.abs(e)*10)}function hw(i,e){var t,n;const s=$u(Oi(i,(t=i.x)!==null&&t!==void 0?t:{}),e.x),r=$u(Oi(i,(n=i.y)!==null&&n!==void 0?n:{}),e.y);return Math.max(s,r)}function uw(i){if(!("y"in i))return!1;const e=i.y;return e&&"inverted"in e?!!e.inverted:!1}Gt({id:"input-point2d",type:"input",accept:(i,e)=>{if(!xi.isObject(i))return null;const t=Nt(e,n=>Object.assign(Object.assign({},wr(n)),{expanded:n.optional.boolean,picker:n.optional.custom(Af),readonly:n.optional.constant(!1),x:n.optional.custom(gi),y:n.optional.object(Object.assign(Object.assign({},wr(n)),{inverted:n.optional.boolean}))}));return t?{initialValue:i,params:t}:null},binding:{reader:()=>aw,constraint:i=>cw(i.params,i.initialValue),equals:xi.equals,writer:()=>lw},controller:i=>{var e,t;const n=i.document,s=i.value,r=i.constraint,o=[i.params.x,i.params.y];return new ow(n,{axes:s.rawValue.getComponents().map((a,l)=>{var c;return Ac({constraint:r.components[l],initialValue:a,params:Oi(i.params,(c=o[l])!==null&&c!==void 0?c:{})})}),expanded:(e=i.params.expanded)!==null&&e!==void 0?e:!1,invertsY:uw(i.params),max:hw(i.params,s.rawValue),parser:bi,pickerLayout:(t=i.params.picker)!==null&&t!==void 0?t:"popup",value:s,viewProps:i.viewProps})}});class bs{constructor(e=0,t=0,n=0){this.x=e,this.y=t,this.z=n}getComponents(){return[this.x,this.y,this.z]}static isObject(e){if(mt(e))return!1;const t=e.x,n=e.y,s=e.z;return!(typeof t!="number"||typeof n!="number"||typeof s!="number")}static equals(e,t){return e.x===t.x&&e.y===t.y&&e.z===t.z}toObject(){return{x:this.x,y:this.y,z:this.z}}}const $f={toComponents:i=>i.getComponents(),fromComponents:i=>new bs(...i)};function dw(i){return bs.isObject(i)?new bs(i.x,i.y,i.z):new bs}function fw(i,e){i.writeProperty("x",e.x),i.writeProperty("y",e.y),i.writeProperty("z",e.z)}function pw(i,e){return new Kc({assembly:$f,components:[$n(Object.assign(Object.assign({},i),i.x),e.x),$n(Object.assign(Object.assign({},i),i.y),e.y),$n(Object.assign(Object.assign({},i),i.z),e.z)]})}Gt({id:"input-point3d",type:"input",accept:(i,e)=>{if(!bs.isObject(i))return null;const t=Nt(e,n=>Object.assign(Object.assign({},wr(n)),{readonly:n.optional.constant(!1),x:n.optional.custom(gi),y:n.optional.custom(gi),z:n.optional.custom(gi)}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>dw,constraint:i=>pw(i.params,i.initialValue),equals:bs.equals,writer:i=>fw},controller:i=>{const e=i.value,t=i.constraint,n=[i.params.x,i.params.y,i.params.z];return new qc(i.document,{assembly:$f,axes:e.rawValue.getComponents().map((s,r)=>{var o;return Ac({constraint:t.components[r],initialValue:s,params:Oi(i.params,(o=n[r])!==null&&o!==void 0?o:{})})}),parser:bi,value:e,viewProps:i.viewProps})}});class ys{constructor(e=0,t=0,n=0,s=0){this.x=e,this.y=t,this.z=n,this.w=s}getComponents(){return[this.x,this.y,this.z,this.w]}static isObject(e){if(mt(e))return!1;const t=e.x,n=e.y,s=e.z,r=e.w;return!(typeof t!="number"||typeof n!="number"||typeof s!="number"||typeof r!="number")}static equals(e,t){return e.x===t.x&&e.y===t.y&&e.z===t.z&&e.w===t.w}toObject(){return{x:this.x,y:this.y,z:this.z,w:this.w}}}const Zf={toComponents:i=>i.getComponents(),fromComponents:i=>new ys(...i)};function mw(i){return ys.isObject(i)?new ys(i.x,i.y,i.z,i.w):new ys}function gw(i,e){i.writeProperty("x",e.x),i.writeProperty("y",e.y),i.writeProperty("z",e.z),i.writeProperty("w",e.w)}function _w(i,e){return new Kc({assembly:Zf,components:[$n(Object.assign(Object.assign({},i),i.x),e.x),$n(Object.assign(Object.assign({},i),i.y),e.y),$n(Object.assign(Object.assign({},i),i.z),e.z),$n(Object.assign(Object.assign({},i),i.w),e.w)]})}Gt({id:"input-point4d",type:"input",accept:(i,e)=>{if(!ys.isObject(i))return null;const t=Nt(e,n=>Object.assign(Object.assign({},wr(n)),{readonly:n.optional.constant(!1),w:n.optional.custom(gi),x:n.optional.custom(gi),y:n.optional.custom(gi),z:n.optional.custom(gi)}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>mw,constraint:i=>_w(i.params,i.initialValue),equals:ys.equals,writer:i=>gw},controller:i=>{const e=i.value,t=i.constraint,n=[i.params.x,i.params.y,i.params.z,i.params.w];return new qc(i.document,{assembly:Zf,axes:e.rawValue.getComponents().map((s,r)=>{var o;return Ac({constraint:t.components[r],initialValue:s,params:Oi(i.params,(o=n[r])!==null&&o!==void 0?o:{})})}),parser:bi,value:e,viewProps:i.viewProps})}});function vw(i){const e=[],t=Bc(i.options);return t&&e.push(t),new Lr(e)}Gt({id:"input-string",type:"input",accept:(i,e)=>{if(typeof i!="string")return null;const t=Nt(e,n=>({readonly:n.optional.constant(!1),options:n.optional.custom(qo)}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>Ef,constraint:i=>vw(i.params),writer:i=>Nr},controller:i=>{const e=i.document,t=i.value,n=i.constraint,s=n&&Bo(n,Ko);return s?new Ns(e,{props:new qe({options:s.values.value("options")}),value:t,viewProps:i.viewProps}):new kc(e,{parser:r=>r,props:qe.fromObject({formatter:ql}),value:t,viewProps:i.viewProps})},api(i){return typeof i.controller.value.rawValue!="string"?null:i.controller.valueController instanceof Ns?new Oc(i.controller):null}});const $o={monitor:{defaultRows:3}},Zu=Ye("mll");class xw{constructor(e,t){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=t.formatter,this.element=e.createElement("div"),this.element.classList.add(Zu()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("textarea");n.classList.add(Zu("i")),n.style.height=`calc(var(${Tf("containerUnitSize")}) * ${t.rows})`,n.readOnly=!0,t.viewProps.bindDisabled(n),this.element.appendChild(n),this.textareaElem_=n,t.value.emitter.on("change",this.onValueUpdate_),this.value=t.value,this.update_()}update_(){const e=this.textareaElem_,t=e.scrollTop===e.scrollHeight-e.clientHeight,n=[];this.value.rawValue.forEach(s=>{s!==void 0&&n.push(this.formatter_(s))}),e.textContent=n.join(`
`),t&&(e.scrollTop=e.scrollHeight)}onValueUpdate_(){this.update_()}}class Yc{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.view=new xw(e,{formatter:t.formatter,rows:t.rows,value:this.value,viewProps:this.viewProps})}}const Ju=Ye("sgl");class bw{constructor(e,t){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=t.formatter,this.element=e.createElement("div"),this.element.classList.add(Ju()),t.viewProps.bindClassModifiers(this.element);const n=e.createElement("input");n.classList.add(Ju("i")),n.readOnly=!0,n.type="text",t.viewProps.bindDisabled(n),this.element.appendChild(n),this.inputElement=n,t.value.emitter.on("change",this.onValueUpdate_),this.value=t.value,this.update_()}update_(){const e=this.value.rawValue,t=e[e.length-1];this.inputElement.value=t!==void 0?this.formatter_(t):""}onValueUpdate_(){this.update_()}}class $c{constructor(e,t){this.value=t.value,this.viewProps=t.viewProps,this.view=new bw(e,{formatter:t.formatter,value:this.value,viewProps:this.viewProps})}}Gt({id:"monitor-bool",type:"monitor",accept:(i,e)=>{if(typeof i!="boolean")return null;const t=Nt(e,n=>({readonly:n.required.constant(!0),rows:n.optional.number}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>Sf},controller:i=>{var e;return i.value.rawValue.length===1?new $c(i.document,{formatter:Gu,value:i.value,viewProps:i.viewProps}):new Yc(i.document,{formatter:Gu,rows:(e=i.params.rows)!==null&&e!==void 0?e:$o.monitor.defaultRows,value:i.value,viewProps:i.viewProps})}});class yw extends Rc{get max(){return this.controller.valueController.props.get("max")}set max(e){this.controller.valueController.props.set("max",e)}get min(){return this.controller.valueController.props.get("min")}set min(e){this.controller.valueController.props.set("min",e)}}const ui=Ye("grl");class Mw{constructor(e,t){this.onCursorChange_=this.onCursorChange_.bind(this),this.onValueUpdate_=this.onValueUpdate_.bind(this),this.element=e.createElement("div"),this.element.classList.add(ui()),t.viewProps.bindClassModifiers(this.element),this.formatter_=t.formatter,this.props_=t.props,this.cursor_=t.cursor,this.cursor_.emitter.on("change",this.onCursorChange_);const n=e.createElementNS(Pn,"svg");n.classList.add(ui("g")),n.style.height=`calc(var(${Tf("containerUnitSize")}) * ${t.rows})`,this.element.appendChild(n),this.svgElem_=n;const s=e.createElementNS(Pn,"polyline");this.svgElem_.appendChild(s),this.lineElem_=s;const r=e.createElement("div");r.classList.add(ui("t"),Ye("tt")()),this.element.appendChild(r),this.tooltipElem_=r,t.value.emitter.on("change",this.onValueUpdate_),this.value=t.value,this.update_()}get graphElement(){return this.svgElem_}update_(){const{clientWidth:e,clientHeight:t}=this.element,n=this.value.rawValue.length-1,s=this.props_.get("min"),r=this.props_.get("max"),o=[];this.value.rawValue.forEach((h,d)=>{if(h===void 0)return;const p=Qe(d,0,n,0,e),g=Qe(h,s,r,t,0);o.push([p,g].join(","))}),this.lineElem_.setAttributeNS(null,"points",o.join(" "));const a=this.tooltipElem_,l=this.value.rawValue[this.cursor_.rawValue];if(l===void 0){a.classList.remove(ui("t","a"));return}const c=Qe(this.cursor_.rawValue,0,n,0,e),u=Qe(l,s,r,t,0);a.style.left=`${c}px`,a.style.top=`${u}px`,a.textContent=`${this.formatter_(l)}`,a.classList.contains(ui("t","a"))||(a.classList.add(ui("t","a"),ui("t","in")),Oo(a),a.classList.remove(ui("t","in")))}onValueUpdate_(){this.update_()}onCursorChange_(){this.update_()}}class Jf{constructor(e,t){if(this.onGraphMouseMove_=this.onGraphMouseMove_.bind(this),this.onGraphMouseLeave_=this.onGraphMouseLeave_.bind(this),this.onGraphPointerDown_=this.onGraphPointerDown_.bind(this),this.onGraphPointerMove_=this.onGraphPointerMove_.bind(this),this.onGraphPointerUp_=this.onGraphPointerUp_.bind(this),this.props=t.props,this.value=t.value,this.viewProps=t.viewProps,this.cursor_=Pt(-1),this.view=new Mw(e,{cursor:this.cursor_,formatter:t.formatter,rows:t.rows,props:this.props,value:this.value,viewProps:this.viewProps}),!Pc(e))this.view.element.addEventListener("mousemove",this.onGraphMouseMove_),this.view.element.addEventListener("mouseleave",this.onGraphMouseLeave_);else{const n=new Vi(this.view.element);n.emitter.on("down",this.onGraphPointerDown_),n.emitter.on("move",this.onGraphPointerMove_),n.emitter.on("up",this.onGraphPointerUp_)}}importProps(e){return Fn(e,null,t=>({max:t.required.number,min:t.required.number}),t=>(this.props.set("max",t.max),this.props.set("min",t.min),!0))}exportProps(){return On(null,{max:this.props.get("max"),min:this.props.get("min")})}onGraphMouseLeave_(){this.cursor_.rawValue=-1}onGraphMouseMove_(e){const{clientWidth:t}=this.view.element;this.cursor_.rawValue=Math.floor(Qe(e.offsetX,0,t,0,this.value.rawValue.length))}onGraphPointerDown_(e){this.onGraphPointerMove_(e)}onGraphPointerMove_(e){if(!e.data.point){this.cursor_.rawValue=-1;return}this.cursor_.rawValue=Math.floor(Qe(e.data.point.x,0,e.data.bounds.width,0,this.value.rawValue.length))}onGraphPointerUp_(){this.cursor_.rawValue=-1}}function Yl(i){return mt(i.format)?Zt(2):i.format}function Sw(i){var e;return i.value.rawValue.length===1?new $c(i.document,{formatter:Yl(i.params),value:i.value,viewProps:i.viewProps}):new Yc(i.document,{formatter:Yl(i.params),rows:(e=i.params.rows)!==null&&e!==void 0?e:$o.monitor.defaultRows,value:i.value,viewProps:i.viewProps})}function Ew(i){var e,t,n;return new Jf(i.document,{formatter:Yl(i.params),rows:(e=i.params.rows)!==null&&e!==void 0?e:$o.monitor.defaultRows,props:qe.fromObject({max:(t=i.params.max)!==null&&t!==void 0?t:100,min:(n=i.params.min)!==null&&n!==void 0?n:0}),value:i.value,viewProps:i.viewProps})}function Qu(i){return i.view==="graph"}Gt({id:"monitor-number",type:"monitor",accept:(i,e)=>{if(typeof i!="number")return null;const t=Nt(e,n=>({format:n.optional.function,max:n.optional.number,min:n.optional.number,readonly:n.required.constant(!0),rows:n.optional.number,view:n.optional.string}));return t?{initialValue:i,params:t}:null},binding:{defaultBufferSize:i=>Qu(i)?64:1,reader:i=>of},controller:i=>Qu(i.params)?Ew(i):Sw(i),api:i=>i.controller.valueController instanceof Jf?new yw(i.controller):null});Gt({id:"monitor-string",type:"monitor",accept:(i,e)=>{if(typeof i!="string")return null;const t=Nt(e,n=>({multiline:n.optional.boolean,readonly:n.required.constant(!0),rows:n.optional.number}));return t?{initialValue:i,params:t}:null},binding:{reader:i=>Ef},controller:i=>{var e;const t=i.value;return t.rawValue.length>1||i.params.multiline?new Yc(i.document,{formatter:ql,rows:(e=i.params.rows)!==null&&e!==void 0?e:$o.monitor.defaultRows,value:t,viewProps:i.viewProps}):new $c(i.document,{formatter:ql,value:t,viewProps:i.viewProps})}});new vf("4.0.5");let ms=null;function zs(){if(!ms)throw new Error("Experience not initialized");return ms}class ww{sizes;time;resources;scene;canvas;camera;renderer;world;running=!1;loaded=!1;initialized=!1;tickHandler=()=>this.update();constructor(e){if(ms)return ms;ms=this,this.canvas=e,this.sizes=new Wb,this.sizes.on("resize",()=>this.resize())}isLoaded(){return this.loaded}isInitialized(){return this.initialized}isPlaying(){return this.running}async load(){this.loaded||(this.resources=new Gb(by),await new Promise(e=>this.resources.on("ready",e)),this.loaded=!0)}init(){if(!this.initialized){if(!this.loaded||!this.resources)throw new Error("Experience.load() must complete before init()");this.time=new Xb({autoplay:!1}),this.scene=new Pm,this.scene.fog=new cc(0,8,35),this.camera=new fy,this.renderer=new xy,this.world=new Yy,this.initialized=!0}}warmup(){this.initialized&&this.update()}play(){!this.initialized||this.running||(this.running=!0,this.time.startLoop(),this.time.on("tick",this.tickHandler))}stop(){this.running=!1,this.time?.off("tick"),this.time?.pause(),this.world?.neonRays.stop(),this.world?.blobManager.reset()}resize(){this.initialized&&(this.camera.resize(),this.renderer.resize(),this.world.neonRays.resize(this.sizes.width,this.sizes.height))}update(){this.initialized&&(this.world.update(),this.camera.update(),this.renderer.update())}destroy(){this.stop(),this.camera?.controls?.dispose(),ms=null}}const Qf=document.getElementById("canvas-3d");if(!Qf)throw new Error("#canvas-3d introuvable");const Tw=new ww(Qf);dy(Tw);
